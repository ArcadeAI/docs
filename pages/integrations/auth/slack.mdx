...
The Arcade [LLM API](/home/use-tools/call-tools-with-llms) is a convenient way to call LLMs and automatically invoke tools. You can use the pre-built [Arcade Slack toolkit](/integrations/toolkits/slack) to quickly build agents and AI apps that interact with Slack.
