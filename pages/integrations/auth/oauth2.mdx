...
- Your [app code](#using-oauth-20-auth-in-your-app-code) that needs to call APIs protected by OAuth 2.0
- Or, your [custom tools](#using-oauth-20-auth-in-customtools) that need to call APIs protected by OAuth 2.0

## Configuring OAuth 2.0

How you configure the OAuth 2.0 provider depends on whether you use the Arcade [Cloud Engine](/home/cloud-engine) or a [self-hosted Engine](/guides/installation).
