...
The Arcade [LLM API](/home/use-tools/call-tools-with-llms) is a convenient way to call LLMs and automatically invoke tools. You can use the pre-built [Arcade GitHub toolkit](/integrations/toolkits/Github/github) to quickly build agents and AI apps that interact with GitHub.
