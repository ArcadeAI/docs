...
The Arcade [LLM API](/home/use-tools/call-tools-with-llms) is a convenient way to call LLMs and automatically invoke tools. You can author your own [custom tools](/home/build-tools/create-a-toolkit) that interact with the Atlassian API.
