...
- The [Arcade Google toolkit](/integrations/toolkits/google), which provides pre-built tools for interacting with Google services
...
How you configure the Google auth provider depends on whether you use the Arcade [Cloud Engine](/home/cloud-engine) or a [self-hosted Engine](/guides/installation).
...
Use the Google auth provider in your own agents and AI apps to get a user token for Google APIs. See [authorizing agents with Arcade](/guides/agentauth) to understand how this works.
...
The Arcade [LLM API](/guides/llmtoolcalling) is a convenient way to call LLMs and automatically invoke tools. You can use the pre-built [Arcade Google toolkit](/integrations/toolkits/google) to quickly build agents and AI apps that interact with Google services like Gmail, Calendar, Drive, and more.

If the pre-built tools in the Google toolkit don't meet your needs, you can author your own [custom tools](/guides/customtools) that interact with Google APIs.
