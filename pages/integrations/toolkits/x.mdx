...
- **`return_attachments_metadata`** _(bool, required, Defaults to True)_ Whether to return metadata about the media attached to the tweet
...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/x/lookup_tweet_by_id_example_llm_oai.py",
        ],
        JavaScript: ["Coming Soon"],
      },
    },
