...
- **`calendar_id`** _(string, optional)_ The ID of the calendar to create the event in, usually 'primary'.
...
- **`updated_visibility`** _(enum ([EventVisibility](/integrations/toolkits/productivity/google/reference#eventvisibility)), optional)_ The visibility of the event
...
- **`send_updates`** _(enum ([SendUpdatesOptions](/integrations/toolkits/productivity/google/reference#sendupdatesoptions)), optional, Defaults to `'all'`)_ Should attendees be notified of the update? (none, all, external_only)
...
- **`send_updates`** _(enum ([SendUpdatesOptions](/integrations/toolkits/productivity/google/reference#sendupdatesoptions)), optional, Defaults to `'all'`)_ Specifies which attendees to notify about the deletion
