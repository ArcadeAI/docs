...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/google/docs/get_document_by_id_example_llm_oai.py",
        ],
        JavaScript: ["Coming Soon"],
      },
    },
...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/google/docs/insert_text_at_end_of_document_example_llm_oai.py",
        ],
        JavaScript: ["Coming Soon"],
      },
    },
...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/google/docs/create_blank_document_example_llm_oai.py",
        ],
        JavaScript: ["Coming Soon"],
      },
    },
...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/google/docs/create_document_from_text_example_llm_oai.py",
        ],
        JavaScript: ["Coming Soon"],
      },
    },
