...
- **`dict`**: The document contents as a dictionary
...
- **`dict`**: The response from the batchUpdate API as a dict
...
- **`dict`**: The created document's title, documentId, and documentUrl in a dictionary
