...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/search/google_jobs/search_jobs_example_llm_oai.py",
        ],
        JavaScript: ["/examples/integrations/toolkits/search/google_jobs/search_jobs_example_llm_oai.js"],
      },
    },
  ]}
/>
...
- `ARCADE_GOOGLE_JOBS_LANGUAGE`: a default value for the news search tools. If not set, defaults to `ARCADE_GOOGLE_LANGUAGE`.
