...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      label: "Execute the Tool with OpenAI",
      content: {
        Python: ["/examples/integrations/toolkits/search/walmart/get_walmart_product_details_example_llm_oai.py"],
        JavaScript: ["/examples/integrations/toolkits/search/walmart/get_walmart_product_details_example_llm_oai.js"],
      },
    },
  ]}
/>
