...
<TableOfContents
  ...
  data={
    [
      ["Search.SearchWalmartProducts", "Search for products listed on Walmart stores."],
      ["Search.GetWalmartProductDetails", "Get details about a product listed on Walmart."],
    ]
  }
/>
