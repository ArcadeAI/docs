...
<TableOfContents
  ...
  data={
    [
      ["Search.GetDirectionsBetweenAddresses", "Get directions between two addresses."],
      ["Search.GetDirectionsBetweenCoordinates", "Get directions between two latitude/longitude coordinates."],
    ]
  }
/>
