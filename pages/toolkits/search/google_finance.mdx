...
<TableOfContents
  ...
  data={
    [
      ['Search.GetStockSummary', "Retrieve current price and recent price movement of a stock."],
      ['Search.GetStockHistoricalData', "Fetch historical stock price and volume data for a specified time window."]
    ]
  }
/>
