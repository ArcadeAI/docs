...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/search/google_news/search_news_example_llm_oai.py",
        ],
        JavaScript: ["/examples/integrations/toolkits/search/google_news/search_news_example_llm_oai.js"],
      },
    },
  ]}
/>
