...
The Arcade Cloud Platform offers a default Hubspot auth provider. If you use it, there's nothing to configure. Your users will see `Arcade` as the name of the application requesting permission.
...
With a [self-hosted installation of Arcade](/home/local-deployment/install/local), you must [configure the Hubspot auth provider](/home/auth-providers/hubspot) with your own Hubspot app credentials.
