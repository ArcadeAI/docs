...
In order to use the Salesforce toolkit (or develop custom tools for Salesforce), you have to [self-host the Arcade Engine](/home/install/local) and [configure the Salesforce auth provider](/home/auth-providers/salesforce) in your engine configuration.
