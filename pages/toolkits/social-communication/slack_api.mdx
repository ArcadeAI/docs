...
import ApiWrapperInfo from "@/components/ApiWrapperInfo";
...
<ToolInfo
  description="Enable agents to interact with ArcadeSlackApi"
  author="Arcade"
  authType="OAuth2"
  versions={["0.1.0"]}
/>
...
<ApiWrapperInfo toolkit_name="ArcadeSlackApi"/>

The ArcadeSlackApi toolkit offers a comprehensive set of pre-built tools for interacting with Slack. These tools make it easy to build agents and AI apps that can:

- Send, schedule, edit, delete, and retrieve messages (including ephemeral messages and thread messages).
- Search and manage files and remote files (search, get metadata, upload URLs, share remote files, enable public sharing).
- Manage conversations and channels (create/join/open/resume conversations, list accessible conversations and channels, invite users, fetch members, set read cursor).
- Manage user and team data (find users by email, get user profiles/presence/identity, list workspace users/owners, fetch team and workspace info and preferences, workspace name/description updates).
- Manage user groups and memberships (create, update, enable/disable user groups, update group users, list channels for usergroup).
- Handle calls and participants (register calls, add/remove participants, get call info).
- Manage bookmarks, pins, and pinned items (list, add, edit, remove).
- Manage reactions and emojis (add/remove reactions, list/rename/add emoji aliases, list enterprise emojis).
- Admin and invite workflows (list/approve/deny/shared invites, accept Slack Connect invites, list approved/denied/pending workspace invite requests).
- Retrieve logs, audit, and org-level info (integration logs, billable users, teams in enterprise, enterprise emoji lists).
- Token and API utilities (revoke tokens, verify API calling code, custom URL unfurls, get message permalinks).

These tools cover messaging automation, user and group administration, file and emoji management, call coordination, and enterprise/admin operations within Slack.
  ...
  tabs={[
    {
      ...
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_remote_files_info_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_remote_files_info_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_thread_messages_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_thread_messages_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/search_slack_messages_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/search_slack_messages_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/add_slack_reaction_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/add_slack_reaction_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/send_slack_message_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/send_slack_message_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/set_workspace_description_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/set_workspace_description_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/find_slack_user_by_email_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/find_slack_user_by_email_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_integration_logs_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_integration_logs_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/check_slack_discoverability_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/check_slack_discoverability_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/pin_item_to_slack_channel_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/pin_item_to_slack_channel_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/share_remote_file_in_channel_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/share_remote_file_in_channel_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/disable_user_group_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/disable_user_group_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/set_slack_workspace_name_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/set_slack_workspace_name_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/accept_slack_invite_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/accept_slack_invite_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_team_preferences_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_team_preferences_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_slack_team_users_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_slack_team_users_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/enable_slack_user_group_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/enable_slack_user_group_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/schedule_slack_message_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/schedule_slack_message_example_call_tool.js"],
      },
    },
  ]}
/>
...
- **attachments_json** (`string[string]`, optional) A JSON array of structured attachments as a URL-encoded string for the Slack message.
- **structured_blocks_json** (`string[string]`, optional) A URL-encoded string of a JSON-based array containing structured blocks for message formatting.
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/custom_unfurl_slack_urls_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/custom_unfurl_slack_urls_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_slack_enterprise_emojis_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_slack_enterprise_emojis_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/revoke_slack_token_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/revoke_slack_token_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_workspace_users_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_workspace_users_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/create_slack_conversation_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/create_slack_conversation_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/approve_slack_channel_invitation_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/approve_slack_channel_invitation_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/remove_reaction_from_item_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/remove_reaction_from_item_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/remove_slack_bookmark_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/remove_slack_bookmark_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/send_ephemeral_message_slack_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/send_ephemeral_message_slack_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_remote_file_info_slack_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_remote_file_info_slack_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/update_slack_user_group_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/update_slack_user_group_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/add_slack_emoji_alias_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/add_slack_emoji_alias_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/check_api_calling_code_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/check_api_calling_code_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/rename_slack_emoji_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/rename_slack_emoji_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_approved_workspace_invite_requests_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_approved_workspace_invite_requests_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_slack_user_groups_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_slack_user_groups_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_message_permalink_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_message_permalink_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/register_slack_call_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/register_slack_call_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/join_slack_conversation_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/join_slack_conversation_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_team_billable_users_info_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_team_billable_users_info_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/update_slack_usergroup_users_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/update_slack_usergroup_users_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/set_slack_channel_read_cursor_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/set_slack_channel_read_cursor_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_accessible_slack_conversations_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_accessible_slack_conversations_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_slack_workspace_owners_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_slack_workspace_owners_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/open_or_resume_slack_conversation_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/open_or_resume_slack_conversation_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/invite_user_to_slack_channel_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/invite_user_to_slack_channel_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_slack_channels_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_slack_channels_example_call_tool.js"],
      },
    },
  ]}
/>
...
- **channel_types** (`string[string]`, optional) Comma-separated list of channel types to include, e.g., 'public_channel', 'private_channel', 'mpim', 'im'. (default: 'public_channel')
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_user_profile_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_user_profile_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_shared_channel_invites_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_shared_channel_invites_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_pending_workspace_invites_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_pending_workspace_invites_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/enable_slack_file_sharing_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/enable_slack_file_sharing_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/add_call_participants_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/add_call_participants_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/edit_slack_bookmark_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/edit_slack_bookmark_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_team_profile_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_team_profile_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_pinned_items_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_pinned_items_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_conversation_members_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_conversation_members_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_user_presence_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_user_presence_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_user_identity_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_user_identity_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/fetch_workspace_settings_info_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/fetch_workspace_settings_info_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_custom_emoji_for_team_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_custom_emoji_for_team_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/create_slack_user_group_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/create_slack_user_group_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/remove_call_participants_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/remove_call_participants_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/delete_scheduled_slack_message_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/delete_scheduled_slack_message_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/search_files_in_slack_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/search_files_in_slack_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/set_slack_profile_photo_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/set_slack_profile_photo_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/deny_shared_invite_request_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/deny_shared_invite_request_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_external_file_upload_url_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_external_file_upload_url_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_current_slack_team_info_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_current_slack_team_info_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_channels_for_usergroup_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_channels_for_usergroup_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_conversation_info_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_conversation_info_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_call_information_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_call_information_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_teams_in_enterprise_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_teams_in_enterprise_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_scheduled_messages_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_scheduled_messages_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/list_denied_slack_invite_requests_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/list_denied_slack_invite_requests_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_bot_info_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/arcadeslackapi/get_slack_bot_info_example_call_tool.js"],
      },
    },
  ]}
/>
...
The Arcade ArcadeSlackApi toolkit uses the [Slack auth provider](/home/auth-providers/slack) to connect to users' ArcadeSlackApi accounts. Please refer to the [Slack auth provider](/home/auth-providers/slack) documentation to learn how to configure auth.
