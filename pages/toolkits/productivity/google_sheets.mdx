  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/google_sheets/who_am_i_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/google_sheets/who_am_i_example_call_tool.js"],
      },
    },
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/google_sheets/generate_google_file_picker_url_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/google_sheets/generate_google_file_picker_url_example_call_tool.js"],
      },
    },
  ]}
/>
