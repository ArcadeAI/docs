...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/microsoft/outlook_calendar/create_event_example_llm_oai.py",
        ],
        JavaScript: ["/examples/integrations/toolkits/microsoft/outlook_calendar/create_event_example_llm_oai.js"],
      },
    },
  ]}
/>
...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/microsoft/outlook_calendar/get_event_example_llm_oai.py",
        ],
        JavaScript: ["/examples/integrations/toolkits/microsoft/outlook_calendar/get_event_example_llm_oai.js"],
      },
    },
  ]}
/>
...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      label: "Execute the tool with OpenAI",
      content: {
        Python: ["/examples/integrations/toolkits/microsoft/outlook_calendar/list_events_in_time_range_example_llm_oai.py"],
        JavaScript: ["/examples/integrations/toolkits/microsoft/outlook_calendar/list_events_in_time_range_example_llm_oai.js"]
      }
    }
  ]}
/>
