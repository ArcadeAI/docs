...
<TableOfContents
  ...
  data={[
    ...
    ["Microsoft.CreateAndSendEmail", "Create and immediately send a new email in Outlook to the specified recipients"],
    ["Microsoft.ReplyToEmail", "Reply only to the sender of an existing email in Outlook."],
    ["Microsoft.ReplyAllToEmail", "Reply to all recipients of an existing email in Outlook."],
    ["Microsoft.ListEmails", "List emails in the user's mailbox across all folders."],
    ["Microsoft.ListEmailsInFolder", "List the user's emails in the specified folder."],
    ["Microsoft.ListEmailsByProperty", "List emails in the user's mailbox across all folders filtering by a property."]
  ]}
/>
