...
<TableOfContents
  ...
  data={[
    ["Google.SearchDocuments", "Search for documents in the user's Google Drive. Note: This tool currently requires a self-hosted instance of Arcade."],
    ["Google.SearchAndRetrieveDocuments", "Search and retrieve the contents of Google documents in the user's Google Drive. Note: This tool currently requires a self-hosted instance of Arcade."],
    ["Google.GetFileTreeStructure", "Get the file/folder tree structure of the user's Google Drive."],
    ["Google.GenerateGoogleFilePickerUrl", "Generate a Google File Picker URL for user-driven file selection and authorization"],
  ]}
/>
