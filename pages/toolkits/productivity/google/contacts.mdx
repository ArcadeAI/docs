...
<TableOfContents
  ...
  data={[
    ["Google.SearchContactsByEmail", "Search the user's contacts in Google Contacts by email address."],
    ["Google.SearchContactsByName", "Search the user's contacts in Google Contacts by name."],
    ["Google.CreateContact", "Create a new contact record in Google Contacts."],
  ]}
/>
