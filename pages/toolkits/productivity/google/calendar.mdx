...
<TableOfContents
  ...
  data={[
    ...
    ["FindSlotsWhenEveryoneIsFree", "Provides time slots when everyone is free within a given date range and time boundaries."],
  ]}
/>
...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/google/calendar/find_free_slots_example_llm_oai.py",
        ],
        JavaScript: ["/examples/integrations/toolkits/google/calendar/find_free_slots_example_llm_oai.js"],
      },
    },
  ]}
/>
...
<Warning type="warning">
  When using [model calling](/home/use-tools/call-tools-with-models) with the `Google.FindSlotsWhenEveryoneIsFree` tool, always ground the LLM with the current date and day of the week by appending it to the prompt. See examples above for "Execute the Tool with OpenAI".
</Warning>
