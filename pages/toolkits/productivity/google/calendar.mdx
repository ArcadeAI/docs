...
<TabbedCodeBlock
  tabs={[
    ...
    },
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/google/calendar/list_calendars_example_llm_oai.py",
        ],
        JavaScript: ["/examples/integrations/toolkits/google/calendar/list_calendars_example_llm_oai.js"],
      },
    },
  ]}
/>
