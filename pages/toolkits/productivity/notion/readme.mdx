...
An Arcade toolkit designed to interact with Notion, enabling users to find and create pages and databases.
...
2. Set the redirect URI to: `https://cloud.arcade.dev/api/v1/oauth/callback`
3. Save your client ID and secret

### 2. Environment Setup

Add these variables to your `engine.env`:
