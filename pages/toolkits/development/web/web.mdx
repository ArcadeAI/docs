...
<<<<<<<< HEAD:pages/toolkits/development/web/web.mdx
...
========
- **`formats`** _(enum ([Formats](/integrations/toolkits/development/web/reference#formats)), optional)_ The format of the scraped web page. Defaults to `Formats.MARKDOWN`.
>>>>>>>> main:pages/integrations/toolkits/development/web/web.mdx
