...
These APIs give you programmatic control over tool calling. If you just want to integrate tools into an LLM workflow, see [Call tools with LLMs](/guides/llmtoolcalling).

</Steps>

### Next steps

Once you've mastered tool calling, see how you can [build your own tools](/guides/customtools) to integrate any custom functionality or API to your AI workflows.
