...
**Frameworks**
* `[feature - 🚀]` Support and examples for OpenAI Agent SDK in Typescript ([docs](https://docs.arcade.dev/home/oai-agents/overview))
...
**Platform and Engine**
* **🚀 New feature:** Admin APIs released for managing users, secrets, and tools ([API References](https://reference.arcade.dev/api-reference#tag/admin))
* **🐛 Bug fix:** Unauthenticated MCP servers can be called anonymously
* **🚀 New feature:** End-user credentials and auth status can be fetched in batches ([docs](https://docs.arcade.dev/home/auth/tool-auth-status))
