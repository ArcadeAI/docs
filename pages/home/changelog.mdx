...
**Platform and Engine**
* `[maintenance - 🔧]` Allow goreleaser to auto push ([PR #480](https://github.com/ArcadeAI/Engine/pull/480))
* `[maintenance - 🔧]` Tag and release on promotion ([PR #481](https://github.com/ArcadeAI/Engine/pull/481))

**Misc**
* `[feature - 🚀]` Add slack alerts to toolkit publish ([PR #457](https://github.com/ArcadeAI/arcade-ai/pull/457))
* `[maintenance - 🔧]` Add provider name to tool def ([PR #482](https://github.com/ArcadeAI/Engine/pull/482))
* `[maintenance - 🔧]` Overprovision prod ([PR #153](https://github.com/ArcadeAI/Cloud/pull/153))
