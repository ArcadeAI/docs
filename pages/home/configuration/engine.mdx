...
Arcade Engine manages auth for [tools](/guides/authtoolcalling) and [agents](/guides/agentauth). This configuration controls what providers are available, and how tokens are stored.
