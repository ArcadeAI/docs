...
description: "Learn how to build a custom worker image using Arcade AI"
---
...
With this Dockerfile, we start from the Arcade AI worker base image, copy in a file named toolkits.txt, and install each toolkit listed there.
...
Replace "your_secret_here" with a secret of your choice. The worker will be accessible on port 8002 of your local machine.
