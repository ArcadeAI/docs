...
Yes, as long as they use a unique ID, you can add as many providers as you need. An important detail is that you will need to manually [define your authorized tools](https://docs.arcade.dev/home/build-tools/create-a-tool-with-auth#define-your-authorized-tool) to work with this provider.
