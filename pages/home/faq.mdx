...
Arcade is a platform for building and running tools for AI Agents. It provides SDKs, CLIs, and APIs that make it easy to build, test, and deploy your own tools to production.  Arcade provides a runtime that can be used to run tools in a secure and scalable way, including managing authentication, rate limiting, and more.  Arcade has a registry of tools made made by both the Arcade team and the community.
