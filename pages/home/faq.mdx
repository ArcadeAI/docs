...
## What is the difference between the Arcade CLI and the Arcade SDK?

The Arcade CLI is a command line tool that makes it easy to build, test, and deploy your own tools to production.  The Arcade SDKs are libraries that you will use within your own agents and applications to use the tools.
