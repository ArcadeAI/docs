...
<Warning>
  If you intend to use any of the Atlassian toolkits, such as [Jira](/toolkits/productivity/jira) and [Confluence](/toolkits/productivity/confluence), you must set the provider ID to `atlassian`.
</Warning>

- Choose a unique **ID** for your provider (e.g. `atlassian`).
...
<Warning>
  If you intend to use any of the Atlassian toolkits, such as [Jira](/toolkits/productivity/jira) and [Confluence](/toolkits/productivity/confluence), you must set the `provider_id` to `atlassian`.
</Warning>
