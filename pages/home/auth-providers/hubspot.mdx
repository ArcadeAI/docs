...
```python file=<rootDir>/examples/code/integrations/hubspot/custom_auth.py
...
```javascript file=<rootDir>/examples/code/integrations/hubspot/custom_auth.js
...
Use the `Hubspot()` auth class to specify that a tool requires authorization with Hubspot.

```python file=<rootDir>/examples/code/integrations/hubspot/custom_tool.py
