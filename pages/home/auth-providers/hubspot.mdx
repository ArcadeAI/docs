...
<Note>
  If you're adding more than one Hubspot provider and your app relies on the built-in toolkit, please ensure to set the **ID** of one of your Hubspot providers to `hubspot`. This ensures the Arcade Engine will connect the built-in tools to that provider. [Read more](/home/faq#can-i-add-multiple-providers-of-the-same-type).
</Note>
...
When you use tools that require Hubspot auth using your Arcade account credentials, the Arcade Engine will automatically use this Hubspot OAuth provider.
