...
Follow Salesforce's guide to [creating your Connected App](https://help.salesforce.com/s/articleView?id=xcloud.connected_app_create.htm&type=5). Be sure to create a **Connected App**, not a Lightning App.
