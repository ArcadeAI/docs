...
You can use your own LinkedIn credentials in both the Arcade Cloud and in a [self-hosted Arcade Engine](/home/install/local) instance.
...
<Note>
  If you're adding more than one LinkedIn provider and your app relies on the built-in toolkit, please ensure to set the **ID** of one of your LinkedIn providers to `linkedin`. This ensures the Arcade Engine will connect the built-in tools to that provider. [Read more](/home/faq#can-i-add-multiple-providers-of-the-same-type).
</Note>
