...
<Tip>
  Arcade AI has [pre-built integrations](/home/auth-providers) with many popular OAuth 2.0 providers. Use this OAuth 2.0 provider to connect to other systems that aren't pre-built.
</Tip>
