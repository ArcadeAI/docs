...
You can use your own Notion credentials in both the Arcade Cloud and in a [self-hosted Arcade Engine](/home/install/local) instance.
...
<Note>
  If you're adding more than one Notion provider and your app relies on the built-in toolkit, please ensure to set the **ID** of one of your Notion providers to `notion`. This ensures the Arcade Engine will connect the built-in tools to that provider. [Read more](/home/faq#can-i-add-multiple-providers-of-the-same-type).
</Note>
