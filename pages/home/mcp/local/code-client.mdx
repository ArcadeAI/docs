...
async function main() {
  try {
    // Define the command to start the MCP server
    const ARCADE_API_KEY = "arc_o1N86coAgUKkHB8G8H4GVTRg3f3jMVoeaFthhCsWvQJWFw6TG1wg";
    const PATH_TO_PYTHON = "/Users/ericgustin/miniconda3/envs/arcade-ai/bin/python";
    const PATH_TO_ARCADE = "/Users/ericgustin/miniconda3/envs/arcade-ai/bin/arcade";
