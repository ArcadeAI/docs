...
- **Authentication**: Each tool may require different authentication providers.
- **User identification**: Always provide a unique and consistent `user_id` for each user to ensure proper authentication management.
