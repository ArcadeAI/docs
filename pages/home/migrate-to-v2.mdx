...
## Release Timeline
Version 2.0.0 will be released on **Tuesday, June 17th during PST morning hours**. Make sure to pin your project's dependency on `arcade-ai` to the v1 major version before this date to avoid any disruptions.
...
Now, the `arcade-ai` package serves as Arcade.dev's CLI, allowing you to create 'starter' toolkits, serve and deploy toolkits, chat, and more via the command line. Additionally, two new packages have been introduced: `arcade-serve` and `arcade-tdk`.
