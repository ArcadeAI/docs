...
Secrets are sensitive keys like passwords, api-keys, or other tokents that grant access to a protected resource or API.

You'll create a tool that reads data from a postgres database.
