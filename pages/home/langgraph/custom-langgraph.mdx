...
In this guide, we'll walk through how to create a custom LangGraph that prompts the user for authorization of tool calls using Arcade tools.
...
Initialize the `ArcadeToolManager` to fetch and manage tools from Arcade:
