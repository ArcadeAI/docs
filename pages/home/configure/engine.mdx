...
Arcade Engine manages auth for [tools](/home/auth/auth-tool-calling) and [agents](/home/auth/get-a-token-for-a-user). It supports many built-in [auth providers](/home/auth-providers), and can also connect to any [OAuth 2.0](/home/auth-providers/oauth2) authorization server.
...
<Warning>
  You **must** add at least one value of your own to the `security.root_keys` section before deploying to production.
</Warning>
