...
Arcade AI will ask you to authorize with GitHub, and then the AI assistant will use star the [ArcadeAI/arcade-ai](https://github.com/ArcadeAI/arcade-ai) repo on your behalf.
