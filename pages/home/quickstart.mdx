...
Note that in this simple example, we exit the program while we wait for the user to authorize the tool.  In your real applications, you'll be doing something far more interesting - lean more about using Arcade with Frameworks in the [Frameworks](home/langchain/use-arcade-tools) section.
