# Using Pre-Built Toolkits with Arcade AI

In this guide, we'll walk through the process of installing and using pre-built toolkits with Arcade AI. Instead of creating your own toolkit, you'll learn how to leverage existing toolkits to enhance your AI applications.
...
- **Build Custom Tools**: When you're ready, learn how to [create your own custom toolkits](/guides/customtools) to extend your application's capabilities.
