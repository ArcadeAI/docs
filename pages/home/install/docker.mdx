...
where config.yaml is the path to the [configuration file](/home/configure/configuration#sample-configuration).

## Actor

Arcade does not currently provide a prebuilt Actor image. However, you can build your own following the
