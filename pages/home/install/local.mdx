...
For a simple example on using the client, see the [building tools quickstart](/home/custom-tools)
...
Note that the Engine requires connection to at least one Arcade worker to run. `arcade dev` starts both the Engine and a worker automatically.
