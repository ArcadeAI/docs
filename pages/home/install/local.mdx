...
This guide will help you install Arcade and set up your development environment.
...
<Steps>
### Install the Client
To connect to the cloud or local engine, we need to install the arcade-ai client.
