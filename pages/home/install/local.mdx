...
- **Arcade AI Account**: Sign up for an [Arcade AI account](https://arcade-ai.typeform.com/early-access?typeform-source=arcade.dev) if you haven't already.
...
<Tabs items={['macOS (Homebrew)', 'Ubuntu/Debian (APT)', 'Other Operating Systems']}>
  ...
  <Tabs.Tab>
  For other operating systems, download the appropriate binary from the [Arcade AI Releases](https://arcade.dev/releases) page and add it to your system's `PATH`.
  </Tabs.Tab>
</Tabs>
