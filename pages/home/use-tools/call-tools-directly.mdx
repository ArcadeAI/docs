...
Let's use the `SetStarred` tool from the [GitHub toolkit](/integrations/toolkits/Github/github) to star a repo.
...
Next, learn how to build your own custom tools to fit your unique needs.
