...
After analyzing the document, you decide that a meeting is needed with your colleague. You can ask the LLM to schedule a meeting and it will use the [Calendar toolkit](/toolkits/productivity/google/calendar) to do it without you needing to leave the chat.
