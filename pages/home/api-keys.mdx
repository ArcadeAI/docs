...
Before you begin, you'll need an Arcade account - if you haven't created one yet, you can [sign up here](https://account.arcade.dev/registerOrRedirect?return_to=https%3A%2F%2Fapi.arcade.dev%2Fdashboard&new_user_return_to=https%3A%2F%2Fapi.arcade.dev%2Fdashboard%2Fwelcome&utm_source=docs&utm_medium=page&utm_campaign=get-api-key). Once you have an account, you can generate API keys through either our dashboard or CLI.
