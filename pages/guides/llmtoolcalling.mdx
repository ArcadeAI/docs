...
`Google.ListEmails`, Arcade AI coordinates the interaction between the AI model
...
[authorize and call tools programmatically](/guides/toolcalling). This is
useful when you need more control over the tool calling process.

When you're ready to build your own tools, read about
[how to create tools](/guides/customtools).
