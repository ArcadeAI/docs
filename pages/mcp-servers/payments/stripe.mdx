  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: ["/examples/integrations/mcp-servers/stripe/create_customer_example_call_tool.js"],
      },
    }
  ]}
/>
  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: ["/examples/integrations/mcp-servers/stripe/list_customers_example_call_tool.js"],
      },
    }
  ]}
/>
