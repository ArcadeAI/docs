...
For more details on what tools are available and what scopes they require, see the [Zoom toolkit documentation](/mcp-servers/social-communication/zoom).
...
Use Arcade's [tools for Zoom](/mcp-servers/social-communication/zoom) to:
...
- Check our [Zoom toolkit documentation](/mcp-servers/social-communication/zoom)
