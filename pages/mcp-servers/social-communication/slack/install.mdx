...
For more details on what tools are available and what scopes they require, see the [Slack toolkit documentation](/mcp-servers/social-communication/slack).
...
- Check our [Slack toolkit documentation](/mcp-servers/social-communication/slack)
