  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: ["/examples/integrations/mcp-servers/postgres/discover_schemas_example_call_tool.js"],
      },
    }
  ]}
/>
  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: ["/examples/integrations/mcp-servers/postgres/discover_tables_example_call_tool.js"],
      },
    }
  ]}
/>
  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: ["/examples/integrations/mcp-servers/postgres/get_table_schema_example_call_tool.js"],
      },
    }
  ]}
/>
  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: ["/examples/integrations/mcp-servers/postgres/execute_select_query_example_call_tool.js"],
      },
    }
  ]}
/>
