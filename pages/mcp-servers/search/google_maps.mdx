  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/search/google_maps/get_directions_between_addresses_example_call_tool.py",
        ],
        JavaScript: ["/examples/integrations/mcp-servers/search/google_maps/get_directions_between_addresses_example_call_tool.js"],
      },
    }
  ]}
/>
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/search/google_maps/get_directions_between_coordinates_example_call_tool.py",
        ],
        JavaScript: ["/examples/integrations/mcp-servers/search/google_maps/get_directions_between_coordinates_example_call_tool.js"],
      },
    }
  ]}
/>
