  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/search/google_search/search_google_example_call_tool.py",
        ],
        JavaScript: ["/examples/integrations/mcp-servers/search/google_search/search_google_example_call_tool.js"],
      },
    }
  ]}
/>
