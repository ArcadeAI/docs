  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/search/google_hotels/search_hotels_example_call_tool.py",
        ],
        JavaScript: ["/examples/integrations/mcp-servers/search/google_hotels/search_hotels_example_call_tool.js"],
      },
    }
  ]}
/>
