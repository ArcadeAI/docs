  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/search/google_news/search_news_example_call_tool.py",
        ],
        JavaScript: ["/examples/integrations/mcp-servers/search/google_news/search_news_example_call_tool.js"],
      },
    }
  ]}
/>
