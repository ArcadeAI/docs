  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/search/google_jobs/search_jobs_example_call_tool.py",
        ],
        JavaScript: ["/examples/integrations/mcp-servers/search/google_jobs/search_jobs_example_call_tool.js"],
      },
    }
  ]}
/>
