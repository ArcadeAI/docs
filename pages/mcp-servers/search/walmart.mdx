  ...
  tabs={[
    {
      ...
      content: {
        Python: ["/examples/integrations/mcp-servers/search/walmart/search_walmart_products_example_call_tool.py"],
        JavaScript: ["/examples/integrations/mcp-servers/search/walmart/search_walmart_products_example_call_tool.js"],
      },
    }
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/mcp-servers/search/walmart/get_walmart_product_details_example_call_tool.py"],
        JavaScript: ["/examples/integrations/mcp-servers/search/walmart/get_walmart_product_details_example_call_tool.js"],
      },
    }
  ]}
/>
