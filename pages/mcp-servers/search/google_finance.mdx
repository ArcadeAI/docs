  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: ["/examples/integrations/mcp-servers/search/google_finance/get_stock_summary_example_call_tool.js"],
      },
    }
  ]}
/>
  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: ["/examples/integrations/mcp-servers/search/google_finance/get_stock_historical_data_example_call_tool.js"],
      },
    }
  ]}
/>
