  ...
  tabs={[
    {
      label: "Call the Tool with User Authorization",
      content: {
        Python: ["/examples/integrations/mcp-servers/google_contacts/who_am_i_example_call_tool.py"],
        JavaScript: ["/examples/integrations/mcp-servers/google_contacts/who_am_i_example_call_tool.js"],
      },
    },
  ]}
/>
