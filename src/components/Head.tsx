...
export const Head = () => {
    ...
    const image = frontMatter.ogImage ? "https://docs.arcade-ai.com" + frontMatter.ogImage : "https://docs.arcade-ai.com/images/engine/arcadeai.png";
    const video = frontMatter.ogVideo ? "https://docs.arcade-ai.com" + frontMatter.ogVideo : null;
