...
For more details on what tools are available and what scopes they require, see the [Slack MCP Server documentation](/resources/integrations/social-communication/slack.md).

The Arcade app for Slack requires an active Arcade account. If you don’t have one yet,

[sign up for free](https://api.arcade.dev/dashboard/register)
...
Use Arcade’s [tools for Slack](/resources/integrations/social-communication/slack.md) to:
