...
[![PyPI Version](https://img.shields.io/pypi/v/arcade_firecrawl)](https://pypi.org/project/arcade_firecrawl/)
[![License](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/arcadeai/arcade-ai/blob/main/LICENSE)
[![Python Versions](https://img.shields.io/pypi/pyversions/arcade_firecrawl)](https://pypi.org/project/arcade_firecrawl/)
[![Wheel Status](https://img.shields.io/pypi/wheel/arcade_firecrawl)](https://pypi.org/project/arcade_firecrawl/)
[![Downloads](https://img.shields.io/pypi/dm/arcade_firecrawl)](https://pypi.org/project/arcade_firecrawl/)

The Arcade Firecrawl MCP Server provides a pre-built set of tools for interacting with websites. These tools make it easy to build agents and AI apps that can:
...
These tools are currently available in the Arcade Firecrawl MCP Sever.
...
-   **Environment Variables Required:**
    -   `FIRECRAWL_API_KEY`: Your [Firecrawl](https://www.firecrawl.dev/)
          API key.

**Parameters**

-   **`url`** _(string, required)_ The URL to scrape.
-   **`formats`** _(enum ([Formats](/resources/integrations/development/firecrawl/reference.md#formats)
    ), optional)_ The format of the scraped web page. Defaults to `Formats.MARKDOWN`.
...
The Arcade Web MCP Sever uses [Firecrawl](https://www.firecrawl.dev/)  to scrape, crawl, and map websites.
