      ...
      <div className="p-4">
        ...
        {pagedTools.length > 0 ? (
              ...
              return (
                ...
                >
                  ...
                  <div className="relative flex-1 overflow-hidden">
                    <span className="block truncate text-foreground text-sm group-hover:opacity-0">
                      {tool.name}
                    </span>
                    <span className="pointer-events-none absolute inset-0 hidden whitespace-nowrap text-foreground text-sm group-hover:block group-hover:animate-[tool-name-marquee_6s_linear_infinite]">
                      {tool.name}
                    </span>
                  </div>
          ...
          <div className="mb-4 rounded-lg bg-neutral-dark/30 p-4">
            <p className="text-foreground text-sm">No tools selected.</p>
            {!showUnselectedTools && (
