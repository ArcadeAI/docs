...
function AvailableToolsRow({
  ...
  return (
    ...
    >
      ...
      <td className="max-w-[300px] px-4 py-3.5 text-foreground text-sm">
        <ScrollingCell>
        ...
        <div className="flex flex-wrap items-center gap-3 rounded-lg bg-neutral-dark/20 p-3">
          ...
          {enableFilters && (
            ...
            >
              <SelectTrigger
                ...
                className="h-9 w-full border-muted/60 text-sm hover:border-muted sm:w-[180px]"
              >
          ...
          >
            <SelectTrigger
              ...
              className="h-9 w-full border-muted/60 text-sm hover:border-muted sm:w-[140px]"
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
