...
function CodePopup({
  ...
  return (
    ...
    >
      <div
        className="relative mx-4 max-h-[85vh] w-full max-w-3xl overflow-hidden rounded-2xl border border-neutral-dark-high/60 bg-neutral-dark shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between border-b border-neutral-dark-high/50 bg-gradient-to-r from-neutral-dark to-neutral-dark/80 px-5 py-4">
...
export function DynamicCodeBlock({
  ...
  return (
    <div className="my-4">
      {displayLabel && (
        <p className="mb-3 text-sm text-muted-foreground">{displayLabel}</p>
      )}
      <div className="flex flex-wrap gap-2">
        {showPython && (
          <button
            className="group flex items-center gap-2.5 rounded-xl border border-[#3776AB]/30 bg-gradient-to-br from-[#3776AB]/10 to-[#3776AB]/5 px-4 py-2.5 text-sm font-medium text-text-color shadow-sm transition-all hover:border-[#3776AB]/50 hover:from-[#3776AB]/20 hover:to-[#3776AB]/10 hover:shadow-md"
        ...
        {showTypeScript && (
          <button
            className="group flex items-center gap-2.5 rounded-xl border border-[#3178C6]/30 bg-gradient-to-br from-[#3178C6]/10 to-[#3178C6]/5 px-4 py-2.5 text-sm font-medium text-text-color shadow-sm transition-all hover:border-[#3178C6]/50 hover:from-[#3178C6]/20 hover:to-[#3178C6]/10 hover:shadow-md"
