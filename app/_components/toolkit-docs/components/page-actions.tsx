...
function CopyPageButton() {
  ...
  return (
    <button
      className="inline-flex items-center gap-2 rounded-md border border-neutral-700 bg-neutral-800/50 px-3 py-1.5 font-medium text-neutral-200 text-sm transition-colors hover:bg-neutral-700/50 disabled:opacity-50"
      disabled={loading}
      onClick={handleCopy}
      type="button"
    >
