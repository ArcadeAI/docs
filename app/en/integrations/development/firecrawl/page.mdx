  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/firecrawl/scrape_url_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/firecrawl/scrape_url_example_call_tool.js",
        ],
      },
    },
  ]}
...
- **`formats`** _(enum ([Formats](/mcp-servers/development/firecrawl/reference#formats)), optional)_ The format of the scraped web page. Defaults to `Formats.MARKDOWN`.
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/firecrawl/crawl_website_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/firecrawl/crawl_website_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/firecrawl/get_crawl_status_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/firecrawl/get_crawl_status_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/firecrawl/get_crawl_data_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/firecrawl/get_crawl_data_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/firecrawl/cancel_crawl_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/firecrawl/cancel_crawl_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/firecrawl/map_website_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/firecrawl/map_website_example_call_tool.js",
        ],
      },
    },
  ]}
