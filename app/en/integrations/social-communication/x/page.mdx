...
The Arcade X MCP Sever uses the [X auth provider](/home/auth-providers/x) to connect to users' X accounts. Please refer to the [X auth provider](/home/auth-providers/x) documentation to learn how to configure auth.
