...
<Callout>
  ...
  tools](/home/build-tools/create-a-mcp-server) with the [Zoom auth
...
The Arcade Zoom MCP Sever uses the [Zoom auth provider](/home/auth-providers/zoom) to connect to users' Zoom accounts.
