...
- [An MCP Server](/build/create-tools/tool-basics/build-mcp-server)
...
In your [MCP Server](/build/create-tools/tool-basics/build-mcp-server), create a new tool that uses the secret:
...
<Callout type="info">
  ...
  the public internet with tool-level authorization and secrets, please follow the [deploying to the cloud with Arcade Deploy](/build/arcade-deploy) guide or the [on-prem MCP
