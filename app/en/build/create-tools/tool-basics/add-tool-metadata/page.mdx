...
- [Organize your MCP server and tools](/build/create-tools/tool-basics/organize-mcp-tools) -- Structure your project as it grows
- [Evaluate your tools](/build/create-tools/evaluate-tools) -- Test tool reliability and performance
- [Handle errors](/build/create-tools/error-handling) -- Return useful errors from your tools
