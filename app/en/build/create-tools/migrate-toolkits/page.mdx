...
<Callout type="info">
  ...
  Server](/build/create-tools/tool-basics/build-mcp-server) guide instead.
</Callout>
<Callout type="info">
  ...
  framework: [Create an MCP Server](/build/create-tools/tool-basics/build-mcp-server)
</Callout>
...
- **Configure MCP clients**: Connect your server to [MCP clients](/build/create-tools/tool-basics/call-tools-mcp) like Claude Desktop, Cursor, or VS Code
