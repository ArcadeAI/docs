...
Arcade also allows you to [build your own tools](/build/create-tools/tool-basics/build-mcp-server) to integrate any custom functionality or API to your Agent or AI workflows.
