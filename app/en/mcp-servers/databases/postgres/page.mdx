...
<ToolInfo
  ...
  author="Arcade"
  codeLink="https://github.com/ArcadeAI/arcade-ai/tree/main/mcp-servers/postgres"
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/postgres/discover_schemas_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/postgres/discover_schemas_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/postgres/discover_tables_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/postgres/discover_tables_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/postgres/get_table_schema_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/postgres/get_table_schema_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/postgres/execute_select_query_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/postgres/execute_select_query_example_call_tool.js",
        ],
      },
    },
  ]}
