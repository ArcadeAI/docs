...
This tool requires the following secrets: `BRIGHTDATA_API_KEY`, `BRIGHTDATA_ZONE` (learn how to [configure secrets](/home/build-tools/create-a-tool-with-secrets#set-the-secret-in-the-arcade-dashboard))
...
- **engine** (`Enum` [SearchEngine](/mcp-servers/development/brightdata/reference#SearchEngine), optional) Search engine to use
- **language** (`string`, optional) Two-letter language code
- **country_code** (`string`, optional) Two-letter country code
- **search_type** (`Enum` [SearchType](/mcp-servers/development/brightdata/reference#SearchType), optional) Type of search
...
- **device** (`Enum` [DeviceType](/mcp-servers/development/brightdata/reference#DeviceType), optional) Device type
...
- **source_type** (`Enum` [SourceType](/mcp-servers/development/brightdata/reference#SourceType), required) Type of data source
...
This tool requires the following secrets: `BRIGHTDATA_API_KEY` (learn how to [configure secrets](/home/build-tools/create-a-tool-with-secrets#set-the-secret-in-the-arcade-dashboard))
