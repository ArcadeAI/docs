...
This tool requires the following secrets: `ZOHO_SERVER_URL` (learn how to [configure secrets](/home/build-tools/create-a-tool-with-secrets))
...
This MCP Server requires the `ZOHO_SERVER_URL` secret to be configured. Learn how to [configure secrets](/home/build-tools/create-a-tool-with-secrets).
