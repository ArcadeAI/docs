...
The Arcade MicrosoftTeams MCP Sever uses the [Microsoft auth provider](/home/auth-providers/microsoft) to connect to users' MicrosoftTeams accounts. Please refer to the [Microsoft auth provider](/home/auth-providers/microsoft) documentation to learn how to configure auth.
