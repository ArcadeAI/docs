  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/hubspot/toolkit_enviroment_guidance_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/hubspot/toolkit_enviroment_guidance_example_call_tool.js",
        ],
      },
    },
  ]}
