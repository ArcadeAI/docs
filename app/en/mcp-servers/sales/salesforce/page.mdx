...
<Callout type="info">
  ...
  Engine](/home/deployment/engine-configuration) and [configure the Salesforce
...
In order to use the Salesforce MCP Sever (or develop custom tools for Salesforce), you have to [self-host the Arcade Engine](/home/deployment/engine-configuration) and [configure the Salesforce auth provider](/home/auth-providers/salesforce) in your engine configuration.
