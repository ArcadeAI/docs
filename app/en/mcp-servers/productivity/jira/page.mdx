...
The Arcade Jira MCP Sever uses the [Atlassian auth provider](/home/auth-providers/atlassian) to connect to users' Jira accounts. Please refer to the [Atlassian auth provider](/home/auth-providers/atlassian) documentation to learn how to configure auth.
