  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: [
          "/examples/integrations/mcp-servers/search/google_maps/get_directions_between_addresses_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: [
          "/examples/integrations/mcp-servers/search/google_maps/get_directions_between_coordinates_example_call_tool.js",
        ],
      },
    },
  ]}
