  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/search/google_shopping/search_shopping_products_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/search/google_shopping/search_shopping_products_example_call_tool.js",
        ],
      },
    },
  ]}
