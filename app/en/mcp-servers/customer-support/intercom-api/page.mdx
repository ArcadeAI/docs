...
This tool requires the following secrets: [`INTERCOM_API_SUBDOMAIN`](#intercom-api-subdomain) (learn how to [configure secrets](/home/build-tools/create-a-tool-with-secrets))
