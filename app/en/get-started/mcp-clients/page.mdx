...
## Just trying Arcade out?

These guides assume you want your own gateway, with a tool list and end-user identities you control. If you are evaluating Arcade for yourself, the [Arcade agent plugin](/get-started/agent-plugin) is faster: one command installs it into Cursor, Claude Code, VS Code, GitHub Copilot CLI, or Codex, there is no API key to create, and you sign in to each app in the browser.
