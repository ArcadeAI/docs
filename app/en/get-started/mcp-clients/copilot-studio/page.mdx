...
<!-- Editorial: Structure section - Changed passive voice "Connect Microsoft Copilot Studio to an Arcade MCP Gateway" to active voice following direct/confident voice guidelines -->
...
You connect Microsoft Copilot Studio to an Arcade MCP Gateway.
