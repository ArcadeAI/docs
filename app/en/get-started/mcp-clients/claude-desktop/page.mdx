...
<Callout type="info">
  **Setting Arcade up for yourself?** Add Arcade to Claude Desktop [as a
  connector](/get-started/agent-plugin/claude-desktop), which needs no API key
  and signs you in to each app in the browser. This guide is for pointing Claude
  Desktop at a gateway you control, with your own tool list and your own
  end-user identities.
</Callout>
