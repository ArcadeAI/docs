...
Give your AI IDE access to Arcade.dev's documentation using the [llms.txt](/en/llms.txt) file. This allows Claude Code, Cursor, and other AI IDEs to access the documentation and help you write code.
...
The LLMs.txt files are available at [`/llms.txt`](/en/llms.txt).

![LLMs.txt example](/en/images/agentic-development/cursor-llms-txt.png)
