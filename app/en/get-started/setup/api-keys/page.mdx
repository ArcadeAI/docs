...
<!-- Editorial: Structure (Default Page Structure) - Added opening sentence; Voice and Tone (Use "you" for reader) - Changed "Before you begin" to direct address -->
...
You can generate API keys through either the dashboard or CLI to authenticate with Arcade.

You'll need an Arcade account - if you haven't created one yet, you can <SignupLink linkLocation="docs:get-api-key">sign up here</SignupLink>. Once you have an account, you can generate API keys through either the dashboard or CLI.
...
1. Copy your API key immediately. It only shows once.
2. Store it securely
