...
- [Get an API key](/en/get-started/setup/api-keys)
- [Run the MCP server quickstart](/en/get-started/quickstarts/mcp-server-quickstart)
- [Browse the Arcade CLI reference](/en/references/arcade-cli)
