...
Using Claude Desktop? It installs from a downloadable bundle instead. See [Install Arcade in Claude Desktop](/get-started/agent-plugin/claude-desktop). For any other client, see [Arcade tools without the plugin](/get-started/agent-plugin/tools-only).
...
For any other client, add the gateway URL by hand. See [Arcade tools without the plugin](/get-started/agent-plugin/tools-only).
