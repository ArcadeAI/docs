...
import { MCPClientInstaller } from "./mcp-client-installer";
...
Ask your agent for an outcome rather than naming a tool. The first time a task needs an app you have not authorized, your agent hands you a link. Approve it and the rest of the task continues, including steps that land in a different app.
