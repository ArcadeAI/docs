...
3. **Add user authentication**: In production, get `userId` from your auth system instead of environment variables. See [Secure your server](/build/create-tools/secure-your-server) for best practices.
