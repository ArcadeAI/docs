...
[TanStack AI](https://tanstack.com/ai/latest/docs) is a type-safe, provider-agnostic SDK for building AI applications in JavaScript and TypeScript. It provides streaming responses, tool calling with Zod schemas, and framework-agnostic primitives for React, Solid, and vanilla JavaScript. Provider adapters let you switch between OpenAI, Anthropic, Google Gemini, and Ollama without rewriting your code.
...
- [toolDefinition](https://tanstack.com/ai/latest/docs/guides/tools#option-1-zod-schemas-recommended) Defines tools with Zod schemas for type-safe parameters. Tools can run on server, client, or both.
