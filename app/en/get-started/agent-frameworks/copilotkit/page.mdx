...
Scaffold a CopilotKit app with the CopilotKit CLI:
...
```bash
pnpm dlx copilotkit@latest init
```
...
```bash
yarn dlx copilotkit@latest init
```
...
Follow the prompts to set up the Built-in Agent. For the full walkthrough, see the [CopilotKit quickstart](https://docs.copilotkit.ai).
