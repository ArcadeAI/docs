...
2. **Add user authentication**: In production, resolve `userId` from your authentication system instead of a static configuration property. See [Secure auth in production](/build/user-facing-agents/secure-auth-production) for best practices.
