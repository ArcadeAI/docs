...
Some tools, like [`GoogleSearch.Search`](/resources/integrations/search/googlesearch#googlesearchsearch), allow AI agents to retrieve information or perform actions without needing user-specific authorization.
