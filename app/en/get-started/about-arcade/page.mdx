...
To learn how Arcade allows for actions (tools) to be authorized through OAuth2 and how to implement it, check out [Authorized Tool Calling](/guides/tool-calling/custom-apps/auth-tool-calling).

## Tools that don't require authorization

Some tools, like [`GoogleSearch.Search`](/en/resources/integrations/search/googlesearch#googlesearchsearch), allow AI agents to retrieve information or perform actions without needing user-specific authorization.
