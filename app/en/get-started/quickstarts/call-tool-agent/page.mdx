...
In this example, we call the tool methods directly. In your real applications and agents, you'll likely be letting the LLM decide which tools to call. Learn more about using Arcade with Frameworks in the [Frameworks](/en/get-started/agent-frameworks) section, or [how to build your own tools](/en/guides/create-tools/tool-basics/build-mcp-server).
