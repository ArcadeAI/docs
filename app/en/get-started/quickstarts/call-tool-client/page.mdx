...
<!-- Editorial: Voice and Tone - Changed "Learn how to call" to direct statement; Structure - Added intro line; What to avoid - Removed "simple" language -->
...
- A name
- A description
- A slug (we recommend this so it's straightforward to remember and share, but the system will generate one if left blank)
