  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/microsoft_teams/who_am_i_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/microsoft_teams/who_am_i_example_call_tool.js"],
      },
    },
  ]}
/>
