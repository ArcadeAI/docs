...
<Callout type="warning">
  ...
  [self-hosted](/home/hosting-options/local-deployment/install/overview)
  instance of Arcade.
</Callout>
...
<Callout>
  ...
  tools](/home/authoring-tools/build-tools/create-a-toolkit) with the [Spotify
  auth
  provider](/home/hosting-options/auth-providers/spotify#using-spotify-auth-in-customtools).
</Callout>
