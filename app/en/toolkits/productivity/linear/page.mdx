...
The Arcade Linear toolkit uses the [Linear auth provider](/home/hosting-options/auth-providers/linear) to connect to users' Linear accounts. Please refer to the [Linear auth provider](/home/hosting-options/auth-providers/linear) documentation to learn how to configure auth.
