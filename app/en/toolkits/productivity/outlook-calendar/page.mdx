  ...
  tabs={[
    {
      label: "Call the Tool with User Authorization",
      content: {
        Python: ["/examples/integrations/toolkits/microsoft/outlook_calendar/who_am_i_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/microsoft/outlook_calendar/who_am_i_example_call_tool.js"],
      },
    },
  ]}
/>
