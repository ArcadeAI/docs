  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/google_contacts/who_am_i_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/toolkits/google_contacts/who_am_i_example_call_tool.js",
        ],
      },
    },
  ]}
