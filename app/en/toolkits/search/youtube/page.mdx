...
- **Secret:**
  - `SERP_API_KEY`: Your SerpAPI API key.
    ...
    [self-hosting](/home/hosting-options/local-deployment/install/overview)
    Arcade. If you're using Arcade Cloud, the secret is already set for you.
    To manage your secrets, go to the [Secrets
