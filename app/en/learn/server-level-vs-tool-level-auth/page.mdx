...
<Callout type="info">
  **Using `arcade deploy`?** If you deploy your MCP server with [`arcade
  deploy`](/en/guides/deployment-hosting/arcade-deploy), Arcade handles
  server-level security for you automatically.
</Callout>

## Quick Comparison

| Aspect                | [Resource Server Auth (Front-Door)](/en/guides/create-tools/secure-your-server/secure-your-mcp-server) | [Tool-Level Authorization](/en/guides/create-tools/tool-basics/create-tool-auth) |
| --------------------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
...
- You've determined that [arcade deploy](/en/guides/deployment-hosting/arcade-deploy) is not a good fit for your use case
...
- You're using [arcade deploy](/en/guides/deployment-hosting/arcade-deploy) to secure your server
...
**A:** Yes, but only for stdio transport or when using [arcade deploy](/en/guides/deployment-hosting/arcade-deploy) (Arcade will protect your MCP server for you).
