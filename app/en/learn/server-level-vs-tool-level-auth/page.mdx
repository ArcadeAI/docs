...
| Aspect                | [Resource Server Auth (Front-Door)](/build/create-tools/secure-your-server/secure-your-mcp-server) | [Tool-Level Authorization](/build/create-tools/tool-basics/create-tool-auth) |
| --------------------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
...
- You've determined that [arcade deploy](/build/arcade-deploy) is not a good fit for your use case
...
- You're using [arcade deploy](/build/arcade-deploy) to secure your server
...
**A:** Yes, but only for stdio transport or when using [arcade deploy](/build/arcade-deploy) (Arcade will protect your MCP server for you).
