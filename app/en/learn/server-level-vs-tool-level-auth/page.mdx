...
<Callout type="info">
**Using `arcade deploy`?** If you deploy your MCP server with [`arcade deploy`](/guides/deployment-hosting/arcade-deploy), Arcade handles server-level security for you automatically.
</Callout>

## Quick Comparison

| Aspect | [Resource Server Auth (Front-Door)](/home/build-tools/secure-your-mcp-server) | [Tool-Level Authorization](/guides/create-tools/tool-basics/create-tool-auth) |
|--------|-----------------------------------|--------------------------|
