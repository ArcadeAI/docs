...
See [How Hooks Work](/en/guides/contextual-access/how-hooks-work) for details on configuring extensions and hook points.

## Next steps

- [Build your own](/en/guides/contextual-access/build-your-own) — Implement the webhook contract in any language
- [API Reference](/en/references/contextual-access-webhook-api) — Interactive schema documentation for the webhook contract
