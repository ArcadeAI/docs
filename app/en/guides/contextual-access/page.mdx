...
![Contextual Access Flow Diagram](/en/images/logic-extensions/flow_diagram.png)

| Hook point | When it runs | What it can do |
| --- | --- | --- |
| **Access Hook** | When listing tools for a user | Allow or deny tools the user can see |
| **Pre-Execution Hook** | Before each tool execution | Allow, deny, or modify inputs |
...
<Cards>
  <Cards.Card
    ...
    href="/en/guides/contextual-access/how-hooks-work"
  />
  <Cards.Card
    title="Run an Extension"
    href="/en/guides/contextual-access/examples"
  />
  <Cards.Card
    title="Build Your Own"
    href="/en/guides/contextual-access/build-your-own"
  />
  <Cards.Card
    title="API Reference"
    href="/en/references/contextual-access-webhook-api"
  />
</Cards>
