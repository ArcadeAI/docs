...
Most setups don't need to touch anything else. If yours does, expand the **Advanced** section at the bottom of the form to customize the requested **Scopes** or the **Subject Claim**. See [Advanced: scopes and subject claim](#advanced-scopes-and-subject-claim) for what's in there and when you'd change it.
