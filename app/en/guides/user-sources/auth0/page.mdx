...
- **Tenant domains and regions**: Newer Auth0 tenants use region-prefixed domains in the form `<tenant>.<region>.auth0.com`. Older tenants use `<tenant>.auth0.com`. Either form works; copy exactly what the **Domain** field on the application's Settings tab displays. See Auth0's [tenant domains documentation](https://auth0.com/docs/get-started/tenant-settings/tenant-domains) for more.
