...
Arcade's other defaults work for the Okta-hosted Org Authorization Server, so you don't need to touch the form's **Advanced** section. See [Advanced: scopes and subject claim](/guides/user-sources#advanced-scopes-and-subject-claim) in the User Sources overview if you do want to customize.
