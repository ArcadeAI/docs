...
Learn how to [connect MCP Gateways to your preferred client](/get-started/mcp-clients). See [Supported MCP protocol versions](/guides/mcp-gateways/protocol-versions) for which protocol versions Arcade gateways support.
