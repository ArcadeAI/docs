...
<Cards>
  <Cards.Card
    ...
    href="/en/guides/mcp-gateways/create-via-dashboard"
  />
  <Cards.Card
    title="Create via AI Assistant"
    href="/en/guides/mcp-gateways/create-via-ai"
  />
</Cards>
...
<Cards>
  <Cards.Card
    ...
    href="/en/guides/mcp-gateways/add-remote-servers"
  />
</Cards>
...
Learn how to [connect MCP Gateways to your preferred client](/en/get-started/mcp-clients).
...
See [Create via Dashboard](/en/guides/mcp-gateways/create-via-dashboard) for detailed authentication configuration.

## Next Steps

- <SignupLink linkLocation="docs:mcp-gateways">Create an Arcade account</SignupLink> if you haven't already
- [Browse available integrations](/en/resources/integrations) to see what tools you can add to your gateway
