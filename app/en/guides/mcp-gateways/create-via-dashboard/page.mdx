...
To create an MCP Gateway, go to the [MCP Gateways dashboard](https://api.arcade.dev/dashboard/mcp-gateways) and click on the "Create MCP Gateway" button.
...
Once you've created a gateway, you'll need to add it to your chat client. The assistant will provide the MCP URL (e.g., `https://api.arcade.dev/mcp/<YOUR-GATEWAY-SLUG>`).
