...
2. An MCP-compatible chat client ([Cursor](/en/get-started/mcp-clients/cursor), [Claude Desktop](/en/get-started/mcp-clients/claude-desktop), [VS Code](/en/get-started/mcp-clients/visual-studio-code), etc.)
...
Each MCP client has a different setup process. See [Connect to MCP clients](/en/get-started/mcp-clients) for detailed instructions for adding the Gateway Assistant to Cursor, Claude Desktop, VS Code, and other supported clients with Arcade Auth.
...
<iframe
  ...
  src="https://www.youtube.com/embed/6thtA-9TA7g"
  title="Arcade Gateway Assistant - Create Gateways via AI"
...
Follow the same process you used to add the Gateway Assistant - see [Connect to MCP clients](/en/get-started/mcp-clients) for setup instructions specific to your client.
