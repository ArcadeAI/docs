...
{/* Editorial: Structure - Added first paragraph following 10/20/70 format with who/what/why/when/where/how; Terminology - Used correct "MCP clients" term */}
...
This guide is for developers building AI applications who need to connect Arcade tools to their agent framework or MCP client. You'll find platform-specific integration guides that show you how to authenticate with Arcade, load tools, and execute them within your chosen framework. Use these guides when you're ready to add external tool capabilities to your agents. Each integration provides code examples and configuration steps to get you started quickly.
