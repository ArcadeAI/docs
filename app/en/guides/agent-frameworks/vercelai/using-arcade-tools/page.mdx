...
- **Arcade API key** from our [Getting your API key guide](/get-started/setup/api-key)
...
Browse our [complete MCP Server catalog](/resources/integrations) to see all available MCP Servers and their capabilities. Each MCP Server comes with pre-built tools that are ready to use with your AI applications. Arcade also is the best way to create your own custom tools and MCP Servers - learn more [here](/guides/create-tools/tool-basics/build-mcp-server).
