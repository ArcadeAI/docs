...
Arcade is available on the Azure Marketplace as a managed application. You deploy it into **your own Azure subscription**, and Arcade operates it for you across tenants. Your data and the services that run Arcade stay in your subscription; Arcade handles upgrades and day-to-day operations.
...
Open the [Arcade offering in the Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace/apps){/* TODO: replace with the exact Arcade listing URL */} and select **Get it now**. Choose the standard plan for a production, single-tenant deployment.
...
Add the redirect URI from the deployment output to your identity provider application, as described in [Set up your identity provider](#set-up-your-identity-provider).
