...
- [Arcade CLI](/en/get-started/quickstarts/call-tool-agent)
...
Follow the [Creating a MCP Server](/en/guides/create-tools/tool-basics/build-mcp-server) guide to create your MCP Server.
...
1. Use an app that supports MCP clients, like AI assistants and IDEs:
   - [Visual Studio Code](/en/get-started/mcp-clients/visual-studio-code)
   - [Claude Desktop](/en/get-started/mcp-clients/claude-desktop)
   - [Cursor](/en/get-started/mcp-clients/cursor)
...
- [Create custom tools](/en/guides/create-tools/tool-basics/build-mcp-server) for your MCP Server
- [Set up authentication](/en/guides/create-tools/tool-basics/create-tool-auth) for secure access to resources
- [Configure secrets](/en/guides/create-tools/tool-basics/create-tool-secrets) for your MCP Server
