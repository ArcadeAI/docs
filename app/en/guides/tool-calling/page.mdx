...
Arcade solves this problem by providing a standardized [interface for authorization](/get-started/about-arcade), as well as pre-built auth providers for [popular services](/references/auth-providers) such as Google, Dropbox, GitHub, Notion, and many more.

Our SDK also [allows you to integrate](/references/auth-providers/oauth2) LLMs with any OAuth 2.0-compliant API.
...
- Explore the [MCP Servers](/resources/integrations) available on Arcade
- Build your own [custom MCP Server](/guides/create-tools/tool-basics/build-mcp-server)
