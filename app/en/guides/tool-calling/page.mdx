...
Or you could ask the LLM to send a summary of the analysis to your colleague by email and it would use the [Gmail MCP Server](/mcp-servers/productivity/gmail) for that.
