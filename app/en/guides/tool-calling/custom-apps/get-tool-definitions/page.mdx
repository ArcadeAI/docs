...
To do this, use the `client.tools.formatted.get` method and specify the tool name and format.

<Tabs items={["Python", "JavaScript"]} storageKey="preferredLanguage">
<Tabs.Tab>
```python
from arcladepy import Arcade
...
To do this, use the `client.tools.formatted.list` method and specify the MCP server and format. Since this method returns an iterator of pages, you can cast to a list to get all the tools.
...
This approach streamlines your code by:
