...
For unattended workflows, move this step into onboarding and [pre-authorize the agent's planned tools](/guides/tool-calling/custom-apps/pre-authorize-tools) before starting background work.
...
Arcade also allows you to [build your own tools](/guides/create-tools/tool-basics/build-mcp-server) to integrate any custom functionality or API to your Agent or AI workflows.

Your tools can use the [service providers supported by Arcade](/references/auth-providers) or you can integrate with any [OAuth2-compatible service](/references/auth-providers/oauth2).
