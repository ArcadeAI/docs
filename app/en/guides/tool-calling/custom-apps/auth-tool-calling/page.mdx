...
Your tools can use the [service providers supported by Arcade](/references/auth-providers/) or you can integrate with any [OAuth2-compatible service](/home/auth-providers/oauth2).
