...
Arcade also allows you to [build your own tools](/en/guides/create-tools/tool-basics/build-mcp-server) to integrate any custom functionality or API to your Agent or AI workflows.

Your tools can use the [service providers supported by Arcade](/en/references/auth-providers) or you can integrate with any [OAuth2-compatible service](/en/references/auth-providers/oauth2).
