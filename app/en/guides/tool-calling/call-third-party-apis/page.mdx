...
- Generate an [Arcade API key](/en/get-started/setup/api-keys) and take note of it
...
Integrate this authorization flow into your application, and explore how you can manage different [auth providers](/en/references/auth-providers) and scopes.
