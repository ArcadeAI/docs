...
| -- | -- | -- | -- | -- | -- |
| `action` | string | No | `null` | \-- | Filter by action (e.g. `AUDIT_ACTION_CREATED`) |
| `source` | string | No | `null` | \-- | Filter by source (e.g. `AUDIT_SOURCE_API`) |
...
| `principal_type` | string | Principal type (e.g. `ACCOUNT`) |
