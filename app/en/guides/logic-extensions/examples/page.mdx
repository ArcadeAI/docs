...
See [How Hooks Work](/guides/logic-extensions/how-hooks-work) for details on configuring extensions and hook points.

## Next steps

- [Build your own](/guides/logic-extensions/build-your-own) — Implement the webhook contract in any language
