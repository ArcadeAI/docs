...
You can browse it interactively on the [API Reference](/references/logic-extensions-api) page.
...
- [API Reference](/references/logic-extensions-api) — Interactive Swagger documentation for the full schema
- [Run an extension](/guides/logic-extensions/examples) — Try the open-source example servers as reference
- [How Hooks Work](/guides/logic-extensions/how-hooks-work) — Understand execution order, phases, and failure modes
