...
<Callout type="info">
  ...
  Server](/en/guides/create-tools/tool-basics/build-mcp-server) guide instead.
</Callout>
<Callout type="info">
  ...
  framework: [Create an MCP Server](/en/guides/create-tools/tool-basics/build-mcp-server)
</Callout>
...
- **Configure MCP clients**: Connect your server to [MCP clients](/en/guides/create-tools/tool-basics/call-tools-mcp) like Claude Desktop, Cursor, or VS Code
