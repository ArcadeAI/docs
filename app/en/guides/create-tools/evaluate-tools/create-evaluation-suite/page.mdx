...
See [Run evaluations](/en/guides/create-tools/evaluate-tools/run-evaluations) for all available options.
...
- Learn how to [run evaluations with different providers](/en/guides/create-tools/evaluate-tools/run-evaluations)
- Explore [capture mode](/en/guides/create-tools/evaluate-tools/capture-mode) to record tool calls
