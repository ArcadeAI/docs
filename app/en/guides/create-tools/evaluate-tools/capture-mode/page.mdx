...
Add critics to validate parameters. See [Critics](/guides/create-tools/evaluate-tools/create-an-evaluation-suite#critics) for options.
...
- [Create evaluation suites](/guides/create-tools/evaluate-tools/create-an-evaluation-suite) with expectations
