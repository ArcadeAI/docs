...
Add critics to validate parameters. See [Critics](/en/guides/create-tools/evaluate-tools/create-evaluation-suite#critics) for options.
...
**Symptom:** tool calls differ between OpenAI and Anthropic
...
- Learn about [comparative evaluations](/en/guides/create-tools/evaluate-tools/comparative-evaluations) to compare tool sources
- [Create evaluation suites](/en/guides/create-tools/evaluate-tools/create-evaluation-suite) with expectations
