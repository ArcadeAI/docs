...
- [Organize your MCP server and tools](/en/guides/create-tools/tool-basics/organize-mcp-tools) -- Structure your project as it grows
- [Evaluate your tools](/en/guides/create-tools/evaluate-tools) -- Test tool reliability and performance
- [Handle errors](/en/guides/create-tools/error-handling) -- Return useful errors from your tools
