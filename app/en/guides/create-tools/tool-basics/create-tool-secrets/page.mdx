...
- [An MCP Server](/en/guides/create-tools/tool-basics/build-mcp-server)
...
1. Utilize the [`arcade configure` CLI command](/en/references/arcade-cli) to configure your MCP client to pass the secrets to your MCP server, or
...
In your [MCP Server](/en/guides/create-tools/tool-basics/build-mcp-server), create a new tool that uses the secret:
...
<Callout type="info">
  ...
  the public internet with tool-level authorization and secrets, please follow the [deploying to the cloud with Arcade Deploy](/en/guides/deployment-hosting/arcade-deploy) guide or the [on-prem MCP
