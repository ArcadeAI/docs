...
1. Utilize the [`arcade configure` CLI command](/references/arcade-cliarcade-configure) to configure your MCP client to pass the secrets to your MCP server, or
