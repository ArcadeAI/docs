...
| --------- | ---------------------------------------------------------------------------- | :------------------------: | :----------------: | :---------------------------: | :--------------------------: |
| stdio     | local                                                                        |             ✅             |         ✅         |              ✅               |              ❌              |
| http      | local ([unprotected](/en/resources/glossary#unprotected-mcp-servers))           |             ✅             |         ❌         |              ❌               |              ❌              |
| http      | remote ([unprotected](/en/resources/glossary#unprotected-mcp-servers))          |             ✅             |         ❌         |              ❌               |              ❌              |
| http      | local ([protected](/en/resources/glossary#protected-mcp-servers))               |             ✅             |         ✅         |              ✅               |              ✅              |
| http      | remote ([protected](/en/resources/glossary#protected-mcp-servers))              |             ✅             |         ✅         |              ✅               |              ✅              |
| http      | Arcade Cloud                                                                 |             ✅             |         ✅         |              ✅               |              ✅              |
