...
When building tools with Arcade MCP, understanding error handling is crucial for creating robust and reliable tools. This guide covers everything you need to know about handling errors from a tool developer's perspective.
...
Learn more about [RetryableToolError](/en/guides/create-tools/error-handling/retry-tools).
...
To learn more about how to handle tool errors in your Agent, see the [Use Tools](/en/guides/tool-calling/error-handling) section.
