...
[Learn to Build Tools →](/resources/creating-tools/tool-basics/build-mcp-server)
...
[Add Your Tools to the Catalog →](/resources/creating-tools/new-functionality/custom-toolkit)
