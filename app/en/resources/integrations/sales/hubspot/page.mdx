...
The Arcade Cloud Platform offers a default [Hubspot auth provider](/home/auth-providers/hubspot). If you use it, there's nothing to configure. Your users will see `Arcade` as the name of the application requesting permission.
