  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/imgflip/search_memes_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/imgflip/search_memes_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/imgflip/get_popular_memes_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/imgflip/get_popular_memes_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/imgflip/create_meme_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/imgflip/create_meme_example_call_tool.js",
        ],
      },
    },
  ]}
