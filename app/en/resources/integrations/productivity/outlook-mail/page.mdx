...
<Badges repo="arcadeai/arcade_outlook_mail" />
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/who_am_i_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/who_am_i_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/create_draft_email_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/create_draft_email_example_call_tool.js",
        ],
      },
    },
  ]}
    ...
    tabs={[
      {
        ...
        content: {
          Python: [
            "/examples/integrations/resources/integrations/microsoft/outlook_mail/update_draft_email_example_call_tool.py",
          ],
          JavaScript: [
            "/examples/integrations/resources/integrations/microsoft/outlook_mail/update_draft_email_example_call_tool.js",
          ],
        },
      },
    ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/send_draft_email_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/send_draft_email_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/create_and_send_email_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/create_and_send_email_example_call_tool.js",
        ],
      },
    },
  ]}
...
- **`reply_type`** (enum ([ReplyType](#replytype)), required): Specify "reply" to reply only to the sender or "reply_all" to reply to all recipients.
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/reply_to_email_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/reply_to_email_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/list_emails_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/list_emails_example_call_tool.js",
        ],
      },
    },
  ]}
...
- **`well_known_folder_name`** (enum ([WellKnownFolderNames](#wellknownfoldernames)), optional): The name of the folder to list emails from. Defaults to None.
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/list_emails_in_folder_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/list_emails_in_folder_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/list_emails_by_property_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/microsoft/outlook_mail/list_emails_by_property_example_call_tool.js",
        ],
      },
    },
  ]}
...
The Arcade Outlook Mail MCP Sever uses the [Microsoft auth provider](/references/auth-providers/microsoft) to connect to users' Microsoft accounts.
...
With a self-hosted installation of Arcade, you need to [configure the Microsoft auth provider](/references/auth-providers/microsoft#configuring-microsoft-auth) with your own Microsoft app credentials.
...
<ToolFooter pipPackageName="arcade_outlook_mail" />
