...
<Callout>
  ...
  provider](/en/references/auth-providers/google#using-google-auth-in-custom-tools).
</Callout>
...
With a self-hosted installation of Arcade, you need to [configure the Google auth provider](/en/references/auth-providers/google#configuring-google-auth) with your own Google app credentials.
