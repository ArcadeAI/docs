...
<Callout>
  ...
  provider](/references/auth-providers/googleusing-google-auth-in-custom-tools).
</Callout>
...
With a self-hosted installation of Arcade, you need to [configure the Google auth provider](/references/auth-providers/googleconfiguring-google-auth) with your own Google app credentials.
