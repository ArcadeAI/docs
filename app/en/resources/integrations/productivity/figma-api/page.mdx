...
The Arcade Figma MCP Server uses the [Figma auth provider](/home/auth-providers/figma) to connect to users' Figma accounts.
...
With a self-hosted installation of Arcade, you need to [configure the Figma auth provider](/home/auth-providers/figma#configuring-figma-auth) with your own Figma app credentials.
