...
Learn how to configure a private OAuth app in the [Figma auth provider documentation](/references/auth-providers/figma).
</Callout>
...
The Arcade Figma MCP Server uses the [Figma auth provider](/references/auth-providers/figma) to connect to users' Figma accounts. Please refer to the [Figma auth provider](/references/auth-providers/figma) documentation to learn how to configure auth.
