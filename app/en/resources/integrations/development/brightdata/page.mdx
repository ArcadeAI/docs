  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/brightdata/scrape_as_markdown_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/brightdata/scrape_as_markdown_example_call_tool.js",
        ],
      },
    },
  ]}
...
This tool requires the following secrets: `BRIGHTDATA_API_KEY`, `BRIGHTDATA_ZONE` (learn how to [configure secrets](/guides/create-tools/tool-basics/create-tool-secrets))
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/brightdata/search_engine_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/brightdata/search_engine_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/brightdata/web_data_feed_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/brightdata/web_data_feed_example_call_tool.js",
        ],
      },
    },
  ]}
...
This tool requires the following secrets: `BRIGHTDATA_API_KEY` (learn how to [configure secrets](/guides/create-tools/tool-basics/create-tool-secrets))
