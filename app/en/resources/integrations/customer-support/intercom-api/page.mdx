...
This tool requires the following secrets: `INTERCOM_API_SUBDOMAIN`. [Check which value to use](#intercom-api-subdomain) for the secret. Learn how to [configure secrets](/home/build-tools/create-a-tool-with-secrets).
...
This tool requires the following secrets: `INTERCOM_API_SUBDOMAIN` (learn how to [configure secrets](/home/build-tools/create-a-tool-with-secrets))
