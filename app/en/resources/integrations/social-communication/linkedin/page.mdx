...
<ToolInfo
  ...
  author="Arcade"
  codeLink="https://github.com/ArcadeAI/arcade-ai/tree/main/resources/integrations/linkedin"
  authType="oauth2"
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/linkedin/create_text_post_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/linkedin/create_text_post_example_call_tool.js",
        ],
      },
    },
  ]}
