...
For more details on what tools are available and what scopes they require, see the [Zoom MCP Server documentation](/mcp-servers/social-communication/zoom).
...
- Check our [Zoom MCP Server documentation](/mcp-servers/social-communication/zoom)
