  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/search/google_shopping/search_shopping_products_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/search/google_shopping/search_shopping_products_example_call_tool.js",
        ],
      },
    },
  ]}
