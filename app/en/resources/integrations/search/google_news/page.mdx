  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/search/google_news/search_news_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/search/google_news/search_news_example_call_tool.js",
        ],
      },
    },
  ]}
