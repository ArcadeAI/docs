  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/resources/integrations/search/google_search/search_google_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/resources/integrations/search/google_search/search_google_example_call_tool.js",
        ],
      },
    },
  ]}
