...
## Don't see the server you need?

Arcade isn't limited to this catalog. You have two options, depending on whether the server already exists:

<Cards num={2}>
  <Cards.Card
    title="Register a remote MCP server"
...
Either way, the server joins your project — or your whole organization — alongside Arcade's own, with the same auth handling, tool filtering, and audit trail.
