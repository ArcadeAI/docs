...
Example apps demonstrate Arcade's capabilities in real-world scenarios, from AI-powered research tools to Slack integrations.

These apps show you how to integrate Arcade tools and MCP servers into workflows and agent systems. You can use them as starting points for your own projects or reference implementations for specific integration patterns. Each app includes complete source code and setup instructions to help you understand implementation details and get started quickly.
