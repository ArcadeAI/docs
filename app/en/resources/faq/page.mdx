...
Arcade makes it easy to build your own tools! You can fork our existing tools, or build your own from scratch. Learn more about [building your own MCP Server](/guides/create-tools/tool-basics/build-mcp-server).
...
For a complete onboarding and runtime pattern, see [pre-authorizing tools for background and autonomous agents](/guides/tool-calling/custom-apps/pre-authorize-tools).
