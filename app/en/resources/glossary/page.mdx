...
_Learn more about [context](/en/guides/create-tools/tool-basics/runtime-data-access)._
...
Tools are commonly referred to by a qualified name that includes their MCP Server. For example, [Gmail.SendEmail](/en/resources/integrations/productivity/gmail#gmailsendemail)

_Learn more about [tools](/en/guides/create-tools/tool-basics/build-mcp-server)._

#### Optimized tools

[Optimized tools](/en/guides/create-tools/improve/types-of-tools#optimized-tools) are designed from scratch to provide the best performance for LLMs in terms of speed, reliability, accuracy, and cost-effectiveness.

#### Unoptimized tools

[Unoptimized tools](/en/guides/create-tools/improve/types-of-tools#unoptimized-tools) are designed to mirror the original HTTP API design of the upstream service. They are not optimized for LLM usage and are not subject to evaluation suites. We recommend thoroughly evaluating each Unoptimized tool with your Agents or chatbots before using it in production.

Understand why [LLMs perform poorly when](/en/guides/create-tools/improve/types-of-tools#why-llms-perform-poorly when-calling-http-apis) calling HTTP APIs.
...
_Learn more about [tool context](/en/guides/create-tools/tool-basics/runtime-data-access)._
...
The 'Arcade API' is a set of endpoints that allow you to interact with the Arcade platform. You can use the API to call tools, get tool definitions, manage user auth, and more. See the [Arcade API Reference](/en/references/api) for more details.
...
_Learn more about [auth providers](/en/references/auth-providers)._
...
Learn more about [authorized tool calling](/en/guides/tool-calling/custom-apps/auth-tool-calling).
...
_Learn more about [tool executions](/en/guides/tool-calling)._
...
_Learn more about [the Arcade clients](/en/references)._
...
_Learn more about evaluations [here](/en/guides/create-tools/evaluate-tools/why-evaluate)._
