...
Every MCP server in Arcade has a visibility scope. A **Project** server is available only in the project it was added to — this includes MCP servers you deploy and remote MCP servers you register. A **Global** server is available to all organizations, projects, and accounts; Arcade's pre-built catalog is served this way.
