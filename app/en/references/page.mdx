...
Complete reference documentation for Arcade's APIs, MCP servers, and available auth providers.
...
<div className="container mx-auto px-4 py-12">
  <div className="mx-auto max-w-4xl">
    ...
    <div className="space-y-8">
      {/* Engine API Section */}
      <div className="rounded-lg border border-gray-200 bg-white p-8 shadow-sm transition-all hover:border-primary/30 hover:shadow-md dark:border-gray-800 dark:bg-[rgba(17,17,17,0.8)]">
        ...
        <div className="flex flex-wrap gap-3">
          <Button render={<Link href="/references/api" />}>
            View API Reference
          </Button>
        </div>
      </div>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-8 shadow-sm transition-all hover:border-primary/30 hover:shadow-md dark:border-gray-800 dark:bg-[rgba(17,17,17,0.8)]">
        ...
        <div className="flex flex-wrap gap-3">
          <Button render={<Link href="/references/mcp/python" />}>
            View SDK Reference
          </Button>
        </div>
      </div>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-8 shadow-sm transition-all hover:border-primary/30 hover:shadow-md dark:border-gray-800 dark:bg-[rgba(17,17,17,0.8)]">
        ...
        <div className="space-y-6">
          ...
          <a
            ...
            target="_blank"
          >
            Learn more and find the latest version for the Java Client
          </a>
          </div>
        </div>
