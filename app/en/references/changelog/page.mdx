...
- `[feature - 🚀]` Launched `https://ctl.arcade.dev/mcp` - Arcade's Gateway Assistant. Connect LLMs to help build MCP gateways
...
<Callout type="important">
  The documentation has been dramatically revamped to focus on making it easier to
  get started with Arcade. Update your links and let users know what you think
...
<Callout type="info">
  As of December 1, 2025, the organization has migrated the MCP servers deployed via `arcade
  deploy` to managed infrastructure. Please ensure you have the latest
...
- `[feature - 🚀]` New users can be invited to projects by email, regardless of whether they have an account on Arcade, or already belong to the organization.
...
<Callout type="important">
  The documentation has been updated to be more clear, consistent, and easier to
  navigate. This includes updated quickstarts, guides, and reference
  information. [Let users know what you think](/resources/contact-us)!
</Callout>

<Callout type="info">
  This week `arcade-mcp` was released, the best way to build MCP servers.
...
<Callout type="info">
  ...
  organize MCP servers, tools, and secrets for easier management, control,
  and access.
</Callout>
...
- `[documentation - 📝]` `llms.txt` is now kept up to date and simplified. Added a new section to the docs for [agentic development](/get-started/setup/connect-arcade-docs).
...
<Callout type="info">
  This week Arcade released a new pricing model which will be better for
...
<Callout type="info">
  ...
  updating OAuth configuration. This can be updated from the
  dashboard.
</Callout>
...
<Callout type="info">
  ...
  This enables more rapid iteration and providing a better experience for
  customers. The previously open-sourced MCP servers are still available in
...
- `[feature - 🚀]` custom `callback_host` for arcade login ([PR #481](https://github.com/Arc