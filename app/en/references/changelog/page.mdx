...
<Callout type="info">
  ...
  [here](/en/guides/contextual-access)
</Callout>
...
- `[feature - 🚀]` Launched `https://ctl.arcade.dev/mcp` - Arcade's Gateway Assistant. Connect your LLM to help build MCP Gateways and MCP Servers for any agent use case. Learn more about it [here](/en/guides/mcp-gateways/create-via-ai)!
...
<Callout type="important">
  ...
  [here](/en/resources/contact-us)!
</Callout>

<Callout type="info">
  MCP Gateways now support OAuth! Learn more about it
  [here](/en/guides/mcp-gateways)!
</Callout>
...
- `[feature - 🚀]` OAuth authentication for `arcade-mcp` servers. Learn more about it [here](/en/guides/create-tools/secure-your-server/secure-your-mcp-server)
- `[maintenance - 🔧]` Ability to run multiple uvicorn workers
- `[maintenance - 🔧]` Include type annotations for `arcade_mcp_server`

**Arcade CLI**

- `[feature - 🚀]` Support multiple orgs & projects in Arcade's CLI. Learn more about it [here](/en/references/arcade-cli)!
...
<Callout type="important">
  ...
  information. [Let us know what you think](/en/resources/contact-us)!
</Callout>
...
<Callout type="info">
  ...
  [here](/en/get-started/quickstarts/mcp-server-quickstart)! Detailed reference
  information for `arcade-mcp` is available [here](/en/references/mcp/python).
</Callout>
...
<Callout type="info">
  ...
  [here](/en/guides/create-tools/mcp-gateways!
</Callout>
...
- `[feature - 🚀]` `arcade-mcp` is now generally available! Learn more about it [here](/en/get-started/quickstarts/mcp-server-quickstart)!
...
- `[feature - 🚀]` MCP Gateways are now generally available! Learn more about them [here](/en/guides/create-tools/mcp-gateways!
...
- `[documentation - 📝]` `llms.txt` is now kept up to date and simplified. We've also added a new section to the docs for [agentic development](/en/get-started/setup/connect-arcade-docs).
...
- `[feature - 🚀]` Box.com Starter MCP Server released ([docs](/en/resources/integrations/productivity/boxapi))
- `[feature - 🚀]` Stripe Starter MCP Server released ([docs](/en/resources/integrations/payments/stripeapi))
...
- `[feature - 🚀]` Introduce [Unoptimized tools](/en/guides/create-tools/improve/types-of-tools), a new type of tool that mirrors the original HTTP API design of the upstream service.
- `[feature - 🚀]` Release Slack started MCP Server which contains support for most of the Slack API.
- `[feature - 🚀]` Include advanced error handling in the following MCP Servers: Google, Microsoft, Slack, and Asana. Learn more about handling tool errors [here](/en/guides/create-tools/error-handling/useful-tool-errors).
...
- `[feature - 🚀]` Sharepoint Toolkit added ([docs](/en/resources/integrations/productivity/microsoft-sharepoint))
...
- `[feature - 🚀]` Support for OpenAI Agent SDK in Typescript ([docs](/en/get-started/agent-frameworks/openai-agents/overview))

**Toolkits**

- `[feature - 🚀]` Jira MCP Server released ([docs](/en/resources/integrations/productivity/jira))
...
- `[feature - 🚀]` End-user credentials and auth status can be fetched in batches ([docs](/en/guides/tool-calling/custom-apps/check-auth-status))
