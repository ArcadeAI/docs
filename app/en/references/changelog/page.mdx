...
- `[feature - 🚀]` Add mcp-apps Vite React UI example demonstrating MCP Apps SDK capabilities.
- `[feature - 🚀]` Add a new Create MCP Gateway app integrating design system UI with Tailwind CSS.
- `[feature - 🚀]` Add onboarding tool to first-party MCP server.
- `[feature - 🚀]` Add TelemetryPassbackMiddleware for serverExecutionTelemetry capability.
- `[feature - 🚀]` Add full support for MCP Resources, enhancing resource registration and JSON Schema generation.
