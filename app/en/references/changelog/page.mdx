...
- `[feature - 🚀]` Added logic to configure the default project via CLI script for identity provider support.
...
- `[documentation - 📝]` Add utility to filter tools by majority version in toolkit documentation.
