...
<Callout>
  ...
  [Arcade GitHub MCP Server](/en/resources/integrations/development/github) is what you want!
</Callout>
...
- The [Arcade GitHub MCP Server](/en/resources/integrations/development/github), which provides pre-built tools for interacting with GitHub
...
<Callout type="info">
  ...
  use a [custom user
  verifier](/en/guides/user-facing-agents/secure-auth-production#build-a-custom-user-verifier).
...
For multiple providers, see [using multiple auth providers](/en/references/auth-providers#using-multiple-providers-of-the-same-type).
...
Use the GitHub auth provider to get a user token for the GitHub API. See [authorizing agents with Arcade](/en/get-started/about-arcade) for details.
...
Use the pre-built [Arcade GitHub MCP Server](/en/resources/integrations/development/github) for quick GitHub integration.
...
- [Arcade GitHub MCP Server](/en/resources/integrations/development/github)
- [Arcade Authorization Guide](/en/get-started/about-arcade)
