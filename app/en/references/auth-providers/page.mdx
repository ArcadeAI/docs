...
- You want to use a service that Arcade [does not have a built-in auth provider for](/en/references/auth-providers/oauth2)
...
If the auth provider you need is not listed, try the [OAuth 2.0](/en/references/auth-providers/oauth2) provider, or [get in touch](mailto:contact@arcade.dev) with us!
...
See the docs about [Authoring Tools](/en/guides/create-tools/tool-basics/build-mcp-server) for more information on how to create and serve a MCP Server.
