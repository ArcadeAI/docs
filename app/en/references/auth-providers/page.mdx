...
**This section is for configuring OAuth**, not for using pre-built tools.
- **Want to use Gmail, Slack, or GitHub tools?** → Go to [Tool Catalog](/tool-catalog)
- **Need to configure your own OAuth app?** → You're in the right place
</Callout>
...
See the docs about [Authoring Tools](/guides/create-tools/tool-basics/build-mcp-server) for more information on how to create and serve a MCP Server.
