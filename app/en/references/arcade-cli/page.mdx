...
installation's discovery document and creates a named [context](#arcade-context):
...
A context is one Arcade installation you have signed in to together with the credentials for it. Sign in to as
many as you need and switch between them.
