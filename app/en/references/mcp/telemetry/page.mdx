...
- Command invoked (e.g., `arcade new`, `arcade evals`, other commands listed [here](/en/references/arcade-cli) )
- Count of local tool executions (we do NOT collect tool names, parameters, or any other personally identifiable information related to the tools you or your agents execute locally or when self-hosted)
