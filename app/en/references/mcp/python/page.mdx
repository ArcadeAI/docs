...
Decorator for registering resources and resource templates. See [Resources](/en/references/mcp/python/resources) for full documentation.
...
Imperative form of `@app.resource`. See [Resources](/en/references/mcp/python/resources) for full documentation.
...
Register a static text resource. See [Resources](/en/references/mcp/python/resources) for full documentation.
...
Register a file-backed resource. See [Resources](/en/references/mcp/python/resources) for full documentation.
