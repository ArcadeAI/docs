...
<Callout type="info">
  The stdio transport is the default transport for MCP servers. It is used by
  Claude Desktop and similar clients to run tools locally. Learn more about the
  different [server types](/guides/create-tools/tool-basics/compare-server-types).
</Callout>
