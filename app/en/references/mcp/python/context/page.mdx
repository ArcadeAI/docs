...
<Callout type="info">
  `Context` instances are automatically created and managed by the MCP server. Annotate your tool's context parameter with `Context` and it will be injected at runtime.
</Callout>
