...
<Callout type="info">
  ...
  handling by default. Use middleware when you need to inspect MCP message content
  (tool names, arguments) — for HTTP-level concerns like request logging or headers,
