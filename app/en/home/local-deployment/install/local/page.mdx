...
For more information on installing toolkits, see the [Toolkit Installation](/home/local-deployment/install/mcp-servers) page.

To see all available toolkits, view the [MCP Servers Page](/mcp-servers).
...
This means that there are no toolkits found in the same environment as the Arcade SDK. Ensure that you are installing the toolkit package in the same environment and see the [Toolkit Installation Guide](/home/local-deployment/install/mcp-servers) for more details.
