...
- `api.public_host` _(optional)_ - Public host of the API (e.g., `my-public-host.com`), in case you want to expose it to the public
...
To expose the API to the public, set `api.public_host` to the public host of the API:
