...
- `[feature - 🚀]` Include advanced error handling in the following MCP Servers: Google, Microsoft, Slack, and Asana. Learn more about handling tool errors [here](/home/build-tools/handle-tool-errorsk).
...
- `[feature - 🚀]` V2.0 of Python Tool Development Kit (TDK) ([migration guide](/home/migrate-to-v2))
