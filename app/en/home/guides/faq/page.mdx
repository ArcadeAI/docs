...
Arcade makes it easy to build your own tools! You can fork our existing tools, or build your own from scratch. Learn more about [building your own toolkit](/home/authoring-tools/build-tools/create-a-toolkit).
...
Tools](/home/hosting-options/auth-providers/google), you can use this code to authenticate once:
