...
<Callout type="warning">
  This page is for enterprise customers who are self-hosting the Arcade Engine.
</Callout>
...
<Tabs items={['macOS (Homebrew)', 'Ubuntu/Debian (APT)', 'Manual Download']}>
  ...
  ```
  <Callout type="info">To manually download the engine.yaml, you can get an example from the [Configuration Templates](/home/local-deployment/configure/configuration-templates#engineyaml) and add it to `$HOME/.arcade/engine.yaml`.</Callout>
  </Tabs.Tab>
</Tabs>
...
<Tabs items={['macOS (Homebrew)', 'Ubuntu/Debian (APT)', 'Manual Download']}>
  ...
  ```
  <Callout type="info">To manually download the `engine.env`, refer to the [Configuration Templates](/home/local-deployment/configure/configuration-templates#engineenv).</Callout>
  </Tabs.Tab>
</Tabs>
