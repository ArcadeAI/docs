...
<Tabs items={['macOS (Homebrew)', 'Ubuntu/Debian (APT)', 'Manual Download']}>
  ...
  ```
  <Callout type="info">To manually download the engine.yaml, you can get an example from the [Configuration Templates](/home/deployment/engine-configuration#engineyaml) and add it to `$HOME/.arcade/engine.yaml`.</Callout>
  </Tabs.Tab>
</Tabs>
...
<Tabs items={['macOS (Homebrew)', 'Ubuntu/Debian (APT)', 'Manual Download']}>
  ...
  ```
  <Callout type="info">To manually download the `engine.env`, refer to the [Configuration Templates](/home/deployment/engine-configuration#engineenv).</Callout>
  </Tabs.Tab>
</Tabs>
...
- `api.development` _(optional, default: `false`)_ - Enable development mode, with more logging and simple [worker authentication](/home/deployment/engine-configuration#http-worker-configuration)
...
For local development, set `api.development = true`. In development mode, Arcade Engine does not require [worker authentication](/home/deployment/engine-configuration#http-worker-configuration).
