...
description: "Learn how to call tools in your custom apps"
---
...
Install and use the Arcade client to call Arcade Hosted Tools with and without auth.
...
- Authorize tools that can act on your behalf on Github, Gmail, and Slack
