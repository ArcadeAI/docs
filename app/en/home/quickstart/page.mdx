...
- **[Build agents that choose tools automatically](/home/langchain/use-arcade-tools)** → LangGraph, OpenAI, Pydantic AI, and more
- **[Browse pre-built tools](/mcp-servers)** → Gmail, Slack, Notion, and more
- **[Build custom tools with MCP](/home/build-tools/create-a-mcp-server)** → Create custom tools for any API
