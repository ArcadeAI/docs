...
Arcade gives your AI agents the power to take action! Authorize your agent to send Gmail, update Notion, message in Slack, and more, using our prebuilt tools and custom ones you define.
...
- **[Build agents that can use tools](/home/agent-frameworks-overview)** using LangGraph, OpenAI, Pydantic AI, and more
