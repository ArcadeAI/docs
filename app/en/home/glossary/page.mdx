...
_Learn more about [tool context](/home/build-tools/tool-context)._
...
_Learn more about [auth providers](/home/auth-providers)._
...
_Learn more about [tool executions](/home/use-tools/tools-overview)._
...
A 'MCP Gateway' is a feature of the Arcade Engine that allows you to add MCP Servers to your project. It is responsible for routing tool execution requests to the correct MCP Server, and for enforcing security and authorization decisions.  You can mix and match MCP Servers from different providers in the same project, and not all tools from a MCP Server need to be available to the same LLM.

### Arcade MCP (Tool Development Kit)

Arcade MCP is a framework for building MCP Servers. It is responsible for the lifecycle of tool executions, and for enforcing security and authorization decisions.
...
_Learn more about evaluations [here](/home/evaluate-tools/why-evaluate-tools)._
