...
Now that you understand the basics of `ToolContext`, you're ready to apply this knowledge in creating your own authorized tools. To learn how to build a custom tool that requires user authorization, check out our guide on [adding user authorization to your tools](/home/authoring-tools/build-tools/create-a-tool-with-auth) or [adding secrets to your tools](/home/authoring-tools/build-tools/create-a-tool-with-secrets).
