...
<div className="grid grid-cols-1 md:grid-cols-[4fr_3fr] gap-8">
  <div>
    This guide walks you through the complete process of creating a custom
    toolkit for Arcade - from initial setup to publishing on PyPI. You'll build
    a simple arithmetic toolkit with operations like addition, subtraction, and
    multiplication. When creating or extending an Arcade toolkit, we make it
...
See [Configuring Arcade Deploy](/home/hosting-options/local-deployment/configure/arcade-deploy) for more configuration options.
...
- **Add authentication**: [Learn how to create tools with authentication](/home/authoring-tools/build-tools/create-a-tool-with-auth)
- **Add secrets**: [Learn how to create tools with secrets](/home/authoring-tools/build-tools/create-a-tool-with-secrets)
- **Evaluate your tools**: [Explore how to evaluate tool performance](/home/authoring-tools/evaluate-tools/why-evaluate-tools)
