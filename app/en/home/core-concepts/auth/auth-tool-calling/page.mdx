...
Arcade also allows you to [build your own tools](/home/authoring-tools/build-tools/create-a-toolkit) to integrate any custom functionality or API to your Agent or AI workflows.

Your tools can use the [service providers supported by Arcade](/home/hosting-options/auth-providers) or you can integrate with any [OAuth2-compatible service](/home/hosting-options/auth-providers/oauth2).
