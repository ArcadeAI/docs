...
<Tabs items={["Python", "JavaScript"]} storageKey="preferredLanguage">
  <Tabs.Tab>
    ```bash pip install arcadepy google-api-python-client google-auth-httplib2
...
<Callout type="info">
  Consider using the [Arcade Gmail toolkit](/toolkits/productivity/gmail), which
  simplifies the process for retrieving email messages even further! The pattern
  described here is useful if you need to directly get a token to use with
  Google in other parts of your codebase.
</Callout>
