...
<Callout type="info">
**Using `arcade deploy`?** If you deploy your MCP server with [`arcade deploy`](/home/serve-tools/arcade-deploy), Arcade handles server-level security for you automatically.
</Callout>
