---
title: "Creating a MCP Server with Arcade"
...
Build a simple arithmetic MCP Server with operations like addition, subtraction, and multiplication.
...
- How to run your local worker with the Arcade CLI and register it with the Engine so that your agent can find and use your tool.
