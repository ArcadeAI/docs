...
### <Discord className="inline-block w-5 h-5 mr-1 -mt-1" /> Discord Community
...
<Callout type="info">
  Email responses are not guaranteed within a specific timeframe. For faster
  assistance, we recommend joining our Discord community.
</Callout>
