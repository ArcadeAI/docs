...
### <Discord className="inline-block w-5 h-5 mr-1 -mt-1 dark:[&>path]:fill-white [&>path]:fill-black" /> Discord Community
...
### <Github className="inline-block w-5 h-5 mr-1 -mt-1" /> GitHub Issues
...
- [Contact our support team](mailto:support@arcade.dev)
- [Contact our sales team](mailto:sales@arcade.dev)
