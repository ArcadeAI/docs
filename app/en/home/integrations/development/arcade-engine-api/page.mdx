  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/mcp-servers/engine_api/get_openapi_specification_example_call_tool.py",
        ],
        JavaScript: [
          "/examples/integrations/mcp-servers/engine_api/get_openapi_specification_example_call_tool.js",
        ],
      },
    },
  ]}
