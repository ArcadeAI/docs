...
- Call a tool that requires authorization
...
- Learn more about the [`Context` object](/home/build-tools/tool-context) and building MCP tools with Arcade
- Learn how to [evaluate tools](/home/evaluate-tools/why-evaluate-tools) to optimize them for LLM usage
