...
Arcade makes it easy to build your own tools! You can fork our existing tools, or build your own from scratch. Learn more about [building your own MCP Server](/home/build-tools/create-a-mcp-server).
...
The [Arcade CLI](/home/arcade-cli) is a command line tool that makes it easy to build, test, and deploy your own tools to production. The [Arcade Client libraries](/home/references) are what you will use within your own agents and applications to call the tools.
...
If you're still using a personal API key, we recommend migrating to a project API key. Learn more about [API keys](/home/api-keys) and how to create them.
