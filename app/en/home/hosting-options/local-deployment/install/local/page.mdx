...
For a simple example on using the Arcade CLI, see the [quickstart on building tools](/home/authoring-tools/build-tools/create-a-toolkit)
...
For more information on installing toolkits, see the [Toolkit Installation](/home/hosting-options/local-deployment/install/toolkits) page.
...
See the [configuration overview](/home/hosting-options/local-deployment/configure/overview) for more information on how to configure Arcade Engine and how to locate the `engine.env` file.
...
- **Building Tools**: Learn how to build tools with your local Arcade Instance in the [Creating a Toolkit](/home/authoring-tools/build-tools/create-a-toolkit) guide.
- **Hosting With Docker**: Learn how to run the [Engine in Docker](/home/hosting-options/local-deployment/install/docker).
...
This means that there are no toolkits found in the same environment as the Arcade SDK. Ensure that you are installing the toolkit package in the same environment and see the [Toolkit Installation Guide](/home/hosting-options/local-deployment/install/toolkits) for more details.
...
If you cannot find your engine config, you can save and use the [Configuration Templates](/home/hosting-options/local-deployment/configure/templates).
