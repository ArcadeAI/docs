...
<Callout type="warning">
  If your project does not have its dependency on `arcade-ai` pinned to the v1
  major version, you must pin it to the v1 major version immediately to prevent
  potential breakages.
</Callout>
...
- **arcade-ai**:
  ...
  - To get [the CLI](https://docs.arcade.dev/home/core-concepts/arcade-cli), install via: `pip install arcade-ai`
  - To get [the evaluation framework](https://docs.arcade.dev/home/authoring-tools/build-tools/evaluation-framework), install via: `pip install 'arcade-ai[evals]'`
  - To get everything including the TDK and Serve, install via: `pip install 'arcade-ai[all]'`

- **arcade-tdk**:

  - If you're [writing your own](https://docs.arcade.dev/home/authoring-tools/build-tools/create-a-toolkit) Arcade tools/toolkits.
  - Install via: `pip install arcade-tdk`

- **arcade-serve**:
  - If you're [writing your own](https://docs.arcade.dev/home/authoring-tools/serve-tools/modal-worker) custom worker.
