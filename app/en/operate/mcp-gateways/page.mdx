...
<Cards>
  <Cards.Card
    ...
    href="/operate/mcp-gateways/create-via-dashboard"
  />
  <Cards.Card
    title="Create via AI Assistant"
    href="/operate/mcp-gateways/create-via-ai"
  />
</Cards>
...
<Cards>
  <Cards.Card
    ...
    href="/operate/mcp-gateways/add-remote-servers"
  />
</Cards>
...
See [User Sources](/operate/user-sources) for how to set up an OIDC identity provider and attach it to a gateway. See [Create via Dashboard](/operate/mcp-gateways/create-via-dashboard) for the rest of the gateway configuration.
