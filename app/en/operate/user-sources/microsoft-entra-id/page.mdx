...
- **Client secret rotation**: Entra client secrets expire. Rotate yours before the expiration date. See [Rotate the client secret](/operate/user-sources#rotate-the-client-secret) in the User Sources guide for how.
