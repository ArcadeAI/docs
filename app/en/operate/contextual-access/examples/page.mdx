...
See [How Hooks Work](/operate/contextual-access/how-hooks-work) for details on configuring extensions and hook points.

## Next steps

- [Build your own](/operate/contextual-access/build-your-own) — Implement the webhook contract in any language
