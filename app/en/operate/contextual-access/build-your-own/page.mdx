...
- [Run an extension](/operate/contextual-access/examples) — Try the open-source example servers as reference
- [How Hooks Work](/operate/contextual-access/how-hooks-work) — Understand execution order, phases, and failure modes
