...
See [How Hooks Work](/operate/governance/contextual-access/how-hooks-work) for details on configuring extensions and hook points.

## Next steps

- [Build your own](/operate/governance/contextual-access/build-your-own) — Implement the webhook contract in any language
