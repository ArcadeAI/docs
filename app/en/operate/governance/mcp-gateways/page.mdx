...
A gateway can federate tools from any server in your project, including MCP servers Arcade does not host. You register a remote server once at the project level, and its tools then appear in the tool picker of every gateway in the project, alongside Arcade's own.
