...
A gateway can federate tools from any server in your project, including MCP servers Arcade does not host. Register the remote server once, and its tools appear in the gateway tool picker alongside Arcade's own.
