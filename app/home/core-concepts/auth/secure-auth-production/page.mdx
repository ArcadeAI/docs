...
<Note>
  ...
  For example, see our docs on [configuring Google auth in the Arcade Dashboard](https://docs.arcade.dev/home/hosting-options/auth-providers/google#access-the-arcade-dashboard).
</Note>
