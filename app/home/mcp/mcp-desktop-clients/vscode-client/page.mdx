...
<Note>
As of version 1.100.0, Visual Studio Code does not yet support [MCP authorization](https://modelcontextprotocol.io/specification/draft/basic/authorization). Only tools that do not require auth, such as math and [search](/toolkits/categories/search/google_search) tools, will work with Visual Studio Code. We're working to improve this - stay tuned!
</Note>
