...
However, if you want to retry the tool call with additional content to improve the tool call's input parameters, you can raise a [RetryableToolError](/home/authoring-tools/build-tools/retry-tools-with-improved-prompt) within the tool.
