...
<Note>
  ...
  a [custom provider configuration](/home/hosting-options/auth-providers/oauth2) as described below.
</Note>
...
- The [Arcade Zendesk toolkit](/toolkits/categories/customer-support/zendesk), which provides pre-built tools for interacting with Zendesk services
...
Use the Zendesk auth provider you just created in your own agents and AI apps to get a user token for Zendesk APIs. See [authorizing agents with Arcade](/home/core-concepts/auth/how-arcade-helps) to understand how this works.
...
If the [Arcade Zendesk toolkit](/toolkits/categories/customer-support/zendesk) does not meet your needs, you can author your own [custom tools](/home/authoring-tools/build-tools/create-a-toolkit) that interact with Zendesk APIs.
