...
- The [Arcade Zendesk toolkit](/toolkits/zendesk), which provides pre-built tools for interacting with Zendesk services
...
If the [Arcade Zendesk toolkit](/toolkits/zendesk) does not meet your needs, you can author your own [custom tools](/home/authoring-tools/build-tools/create-a-toolkit) that interact with Zendesk APIs.
