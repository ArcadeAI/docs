...
You can use your own Discord credentials in both the Arcade Cloud and in a [self-hosted Arcade Engine](/home/hosting-options/local-deployment/install/local) instance.
...
Use the Discord auth provider in your own agents and AI apps to get a user token for the Discord API. See [authorizing agents with Arcade](/home/core-concepts/auth/how-arcade-helps) to understand how this works.
...
You can author your own [custom tools](/home/authoring-tools/build-tools/create-a-toolkit) that interact with the Discord API.
