...
<Tip>
  ...
  [Arcade GitHub toolkit](/toolkits/categories/development/github/github) is what you want!
</Tip>
...
- The [Arcade GitHub toolkit](/toolkits/categories/development/github/github), which provides pre-built tools for interacting with GitHub
...
You can use your own GitHub credentials in both the Arcade Cloud and in a [self-hosted Arcade Engine](/home/hosting-options/local-deployment/install/local) instance.
...
Use the GitHub auth provider in your own agents and AI apps to get a user token for the GitHub API. See [authorizing agents with Arcade](/home/core-concepts/auth/how-arcade-helps) to understand how this works.
...
You can use the pre-built [Arcade GitHub toolkit](/toolkits/categories/development/github/github) to quickly build agents and AI apps that interact with GitHub.

If the pre-built tools in the GitHub toolkit don't meet your needs, you can author your own [custom tools](/home/authoring-tools/build-tools/create-a-toolkit) that interact with the GitHub API.
