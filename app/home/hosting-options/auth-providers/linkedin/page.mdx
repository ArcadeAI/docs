...
You can use your own LinkedIn credentials in both the Arcade Cloud and in a [self-hosted Arcade Engine](/home/hosting-options/local-deployment/install/local) instance.
...
Use the LinkedIn auth provider in your own agents and AI apps to get a user token for LinkedIn APIs. See [authorizing agents with Arcade](/home/core-concepts/auth/how-arcade-helps) to understand how this works.
...
You can author your own [custom tools](/home/authoring-tools/build-tools/create-a-toolkit) that interact with LinkedIn APIs.
