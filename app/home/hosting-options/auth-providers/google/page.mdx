...
<Tip>
  ...
  pre-built [Arcade Gmail toolkit](/toolkits/categories/productivity/gmail) is what
  you want!
</Tip>
...
- The [Arcade Gmail toolkit](/toolkits/categories/productivity/gmail), which provides pre-built tools for interacting with Google services
...
You can use your own Google credentials in both the Arcade Cloud and in a [self-hosted Arcade Engine](/home/hosting-options/local-deployment/install/local) instance.
...
Use the Google auth provider in your own agents and AI apps to get a user token for Google APIs. See [authorizing agents with Arcade](/home/core-concepts/auth/how-arcade-helps) to understand how this works.
...
You can use the pre-built Arcade Google toolkits, like [Arcade Gmail toolkit](/toolkits/categories/productivity/gmail), to quickly build agents and AI apps that interact with Google services like Gmail, Calendar, Drive, and more.

If the pre-built tools in the Google toolkits don't meet your needs, you can author your own [custom tools](/home/authoring-tools/build-tools/create-a-toolkit) that interact with Google APIs.
