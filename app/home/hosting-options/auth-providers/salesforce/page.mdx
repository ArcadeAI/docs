...
<Note>
  ...
  the [Salesforce toolkit](/toolkits/sales/salesforce), or to develop your
  [custom Salesforce tools](/home/authoring-tools/build-tools/create-a-toolkit),
  you must [self-host the Arcade
...
If the pre-built tools in the [Arcade Salesforce toolkit](/toolkits/sales/salesforce) don't meet your needs, you can create your own [custom tools](/home/authoring-tools/build-tools/create-a-toolkit) that interact with the Salesforce APIs.
