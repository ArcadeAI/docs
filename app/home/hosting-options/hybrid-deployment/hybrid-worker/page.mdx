...
Follow the [Creating a Toolkit](/home/authoring-tools/build-tools/create-a-toolkit) guide to create your toolkits.
...
- [Create custom tools](/home/authoring-tools/build-tools/create-a-toolkit) for your hybrid worker
- [Set up authentication](/home/authoring-tools/build-tools/create-a-tool-with-auth) for secure access to resources
- [Configure secrets](/home/authoring-tools/build-tools/create-a-tool-with-secrets) for your worker
