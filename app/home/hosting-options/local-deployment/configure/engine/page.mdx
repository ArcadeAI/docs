...
<Note>
  Ensure you have a worker running before starting the engine. See [arcade serve CLI command](/home/core-concepts/arcade-cli#arcade-serve) for how to start a worker via the CLI.
</Note>
