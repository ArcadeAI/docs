...
```python file=<rootDir>/examples/code/home/agent-frameworks/crewai/custom_auth_flow_callback_section.py
```
...
```python file=<rootDir>/examples/code/home/agent-frameworks/crewai/custom_auth_flow.py
```
