...
To tailor the tool authorization flow to meet your application's specific needs, check out the [Custom Auth Flow with CrewAI](/home/agent-frameworks/crewai/custom-auth-flow) guide.
...
```python file=<rootDir>/examples/code/home/agent-frameworks/crewai/use_arcade_tools.py
```
