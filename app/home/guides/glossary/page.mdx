...
Tools are commonly referred to by a qualified name that includes their toolkit. For example, [Gmail.SendEmail](https://docs.arcade.dev/toolkits/categories/productivity/gmail#gmailsendemail)

*Learn more about [tools](/home/authoring-tools/build-tools/create-a-toolkit).*
...
*Learn more about [tool context](/home/authoring-tools/build-tools/tool-context).*
...
*Learn more about [MCP and Arcade](/home/mcp/mcp-overview).*
...
*Learn more about [authentication providers](/home/hosting-options/auth-providers).*
...
Learn more about [authorized tool calling](/home/core-concepts/auth/auth-tool-calling).
...
*Learn more about [tool executions](/home/core-concepts/use-tools/tools-overview).*
...
*Learn more about [the Arcade clients](/home/core-concepts/arcade-clients).*
...
*Learn more about evaluations [here](/home/authoring-tools/evaluate-tools/why-evaluate-tools).*
