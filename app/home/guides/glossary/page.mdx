...
_Learn more about [tools](/home/authoring-tools/build-tools/create-a-toolkit)._
...
_Learn more about [tool context](/home/authoring-tools/build-tools/tool-context)._
...
_Learn more about [MCP and Arcade](/home/mcp/mcp-overview)._
...
_Learn more about [authentication providers](/home/hosting-options/auth-providers)._
...
_Learn more about [tool executions](/home/core-concepts/use-tools/tools-overview)._
...
_Learn more about [the Arcade clients](/home/core-concepts/arcade-clients)._
...
_Learn more about workers [here](/home/hosting-options/hybrid-deployment/hybrid-worker)._ and [here](/home/authoring-tools/serve-tools/docker-worker).

### TDK (Tool Development Kit)

The Arcade TDK is a command-line application that helps you create, test, and deploy tools.

_Learn more about the TDK [here](/home/authoring-tools/build-tools/create-a-toolkit)._
...
_Learn more about evaluations [here](/home/authoring-tools/evaluate-tools/why-evaluate-tools)._
