...
<ToolInfo
  description="Permitir que los agentes interactúen con bases de datos Clickhouse (solo lectura)."
  author="Arcade"
...
<Callout type="info">
  ...
  listado en el panel de Arcade o en las API. Para uso en producción, recomendamos
...
<TableOfContents
  ...
  data={[
    [
      ...
      "Descubrir todas las bases de datos en una base de datos Clickhouse.",
    ],
    [
      "Clickhouse.DiscoverSchemas",
      "Descubrir todos los esquemas en una base de datos Clickhouse.",
    ],
    ["Clickhouse.DiscoverTables", "Descubrir todas las tablas en un esquema específico."],
    [
      "Clickhouse.GetTableSchema",
      "Obtener el esquema detallado de una tabla específica.",
    ],
    [
  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: [
          "/examples/integrations/toolkits/clickhouse/discover_databases_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: [
          "/examples/integrations/toolkits/clickhouse/discover_schemas_example_call_tool.js",
        ],
      },
    },
  ]}
...
Descubrir todas las tablas en un esquema específico. Esta herramienta debe usarse antes de cualquier otra herramienta que requiera un nombre de tabla.
  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: [
          "/examples/integrations/toolkits/clickhouse/discover_tables_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: [
          "/examples/integrations/toolkits/clickhouse/get_table_schema_example_call_tool.js",
        ],
      },
    },
  ]}
  ...
  tabs={[
    {
      ...
      content: {
        ...
        JavaScript: [
          "/examples/integrations/toolkits/clickhouse/execute_select_query_example_call_tool.js",
        ],
      },
    },
  ]}
