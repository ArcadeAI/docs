...
<ToolInfo
  ...
  author="Arcade"
  codeLink="https://github.com/ArcadeAI/arcade-ai/tree/main/toolkits/google_flights"
  authType="API Key"
  versions={['0.1.0']}
/>
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/categories/search/google_flights/search_one_way_flights_example_call_tool.py",
        ],
        JavaScript: ["/examples/integrations/toolkits/categories/search/google_flights/search_one_way_flights_example_call_tool.js"],
      },
    }
  ]}
/>
