...
- **conversation_types** (`Enum` [ConversationType](/toolkits/categories/social-communication/slack/reference#ConversationType), optional) Optionally filter by the type(s) of conversations. Defaults to None (all types).
