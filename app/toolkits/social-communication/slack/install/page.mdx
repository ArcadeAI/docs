...
For more details on what tools are available and what scopes they require, see the [Slack toolkit documentation](/toolkits/categories/social-communication/slack).
...
Use Arcade's [tools for Slack](/toolkits/categories/social-communication/slack) to:
