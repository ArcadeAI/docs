...
<ToolInfo
  ...
  author="Arcade"
  codeLink="https://github.com/ArcadeAI/arcade-ai/tree/main/toolkits/microsoft_teams"
  authType="OAuth2"
  versions={["0.1.0"]}
/>
...
The Arcade MicrosoftTeams toolkit uses the [Microsoft auth provider](/home/hosting-options/auth-providers/microsoft) to connect to users' MicrosoftTeams accounts. Please refer to the [Microsoft auth provider](/home/hosting-options/auth-providers/microsoft) documentation to learn how to configure auth.
