...
<Warning type="warning" emoji="⚠️">
  The `TrashEmail` tool is currently only available on a self-hosted instance of the Arcade Engine. To learn more about self-hosting, see the [self-hosting documentation](/home/hosting-options/local-deployment/install/local#install-the-engine).
</Warning>
...
The Arcade Gmail toolkit uses the [Google auth provider](/home/hosting-options/auth-providers/google) to connect to users' Google accounts.
