...
<ToolInfo
  ...
  author="Arcade"
  codeLink="https://github.com/ArcadeAI/arcade-ai/tree/main/toolkits/youtube"
  authType="API Key"
  versions={["0.1.0"]}
/>
  ...
  tabs={[
    {
      ...
      content: {
        Python: ["/examples/integrations/toolkits/categories/search/youtube/search_youtube_videos_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/categories/search/youtube/search_youtube_videos_example_call_tool.js"],
      },
    }
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/categories/search/youtube/get_youtube_video_details_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/categories/search/youtube/get_youtube_video_details_example_call_tool.js"],
      },
    }
  ]}
/>
