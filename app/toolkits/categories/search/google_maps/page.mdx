...
<ToolInfo
  ...
  author="Arcade"
  codeLink="https://github.com/ArcadeAI/arcade-ai/tree/main/toolkits/google_maps"
  authType="API Key"
  versions={["0.1.0"]}
/>
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/categories/search/google_maps/get_directions_between_addresses_example_call_tool.py",
        ],
        JavaScript: ["/examples/integrations/toolkits/categories/search/google_maps/get_directions_between_addresses_example_call_tool.js"],
      },
    }
  ]}
/>
...
- **`distance_unit`** _(enum ([GoogleMapsDistanceUnit](#googlemapsdistanceunit)), optional, Defaults to `GoogleMapsDistanceUnit.KM`)_ Distance unit to use in the Google Maps search.
- **`travel_mode`** _(enum ([GoogleMapsTravelMode](#googlemapstravelmode)), optional, Defaults to `GoogleMapsTravelMode.BEST`)_ Travel mode to use in the Google Maps search.
  ...
  tabs={[
    {
      ...
      content: {
        Python: [
          "/examples/integrations/toolkits/categories/search/google_maps/get_directions_between_coordinates_example_call_tool.py",
        ],
        JavaScript: ["/examples/integrations/toolkits/categories/search/google_maps/get_directions_between_coordinates_example_call_tool.js"],
      },
    }
  ]}
/>
