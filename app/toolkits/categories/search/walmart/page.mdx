...
<ToolInfo
  ...
  author="Arcade"
  codeLink="https://github.com/ArcadeAI/arcade-ai/tree/main/toolkits/walmart"
  authType="API Key"
  versions={["0.1.0"]}
/>
  ...
  tabs={[
    {
      ...
      content: {
        Python: ["/examples/integrations/toolkits/categories/search/walmart/search_walmart_products_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/categories/search/walmart/search_walmart_products_example_call_tool.js"],
      },
    }
  ]}
/>
  ...
  tabs={[
    {
      label: "Call the Tool Directly",
      content: {
        Python: ["/examples/integrations/toolkits/categories/search/walmart/get_walmart_product_details_example_call_tool.py"],
        JavaScript: ["/examples/integrations/toolkits/categories/search/walmart/get_walmart_product_details_example_call_tool.js"],
      },
    }
  ]}
/>
