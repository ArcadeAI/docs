...
<Warning>
  This Toolkit is not available in Arcade Cloud. You can use these tools with a [self-hosted](/home/hosting-options/local-deployment/install/overview) instance of Arcade.
</Warning>
...
<Tip>
  ...
  own tools](/home/authoring-tools/build-tools/create-a-toolkit) with the [Spotify auth
