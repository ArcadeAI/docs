  ...
  return (
    ...
    >
      <div className={'flex items-center space-x-3'}>
        ...
        <div
          className={
            'prose flex-1 overflow-x-auto text-sky-900 text-sm dark:text-sky-200'
          }
        >
          {children}
        </div>
  ...
  return (
    ...
    >
      <div className={'flex items-center space-x-3'}>
        ...
        <div
          className={
            'prose flex-1 overflow-x-auto text-amber-900 text-sm dark:text-amber-200'
          }
        >
          {children}
        </div>
  ...
  return (
    ...
    >
      <div className={'flex items-center space-x-3'}>
        ...
        <div
          className={
            'prose flex-1 overflow-x-auto text-emerald-900 text-sm dark:text-emerald-200'
          }
        >
          {children}
        </div>
  ...
  return (
    ...
    >
      <div className={'flex items-center space-x-3'}>
        ...
        <div
          className={
            'prose flex-1 overflow-x-auto text-green-900 text-sm dark:text-green-200'
          }
        >
          {children}
        </div>
